***REMOVED***!/bin/bash
***REMOVED*** Single-shot server start + comprehensive route test
set -e
...
***REMOVED*** Warmup compile (one slow request)
echo "Warming up..."
curl -s --max-time 120 -o /tmp/home.html http://localhost:3000/
sleep 2

***REMOVED*** Test all routes sequentially with short waits
declare -a ROUTES=(
  "/"
  "/services"
  "/services/ai/llm"
...
***REMOVED*** Verify mega menu content in home page HTML
echo ""
...
***REMOVED*** Leave server running for browser testing
echo ""
