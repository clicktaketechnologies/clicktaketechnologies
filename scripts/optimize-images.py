...
files = [
    ("image1.png", "image1.webp", (1200, 853)),  ***REMOVED*** hero-size, 4:3 crop from 1440x1024
    ("image2.jpg", "image2.webp", (1200, 800)),
    ("image3.jpg", "image3.webp", (1200, 800)),
    ("image4.jpg", "image4.webp", (1200, 800)),
    ("clicktake-logo.png", "clicktake-logo.webp", None),  ***REMOVED*** keep original size
]
...
for src_name, dst_name, new_size in files:
    ...
    ***REMOVED*** Resize if requested
    if new_size:
        ***REMOVED*** Use LANCZOS for downscaling (best quality)
        img = img.resize(new_size, Image.LANCZOS)

    ***REMOVED*** Convert to RGB if needed (WebP supports alpha but smaller without)
    has_alpha = img.mode in ("RGBA", "LA") or (img.mode == "P" and "transparency" in img.info)
    if has_alpha:
        ***REMOVED*** Keep alpha for WebP (e.g. logo)
