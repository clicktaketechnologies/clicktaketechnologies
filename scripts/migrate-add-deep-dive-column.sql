...
COMMENT ON COLUMN services.deep_dive IS
  'Phase 3 ***REMOVED***2 — JSON-stringified DeepDiveContent blob from the Master Copywriting prompt (In-Admin LLM Page Creation). Empty for legacy hand-authored pages.';
