...
***REMOVED*** Strip imports/comments for body checks, but keep strings
body_text = content

***REMOVED*** ──────────────────────────────────────────────────────────────────────────
***REMOVED*** 1. Word count — count words inside string literals (rough estimate)
***REMOVED*** ──────────────────────────────────────────────────────────────────────────
***REMOVED*** Pull every double-quoted string
...
***REMOVED*** ──────────────────────────────────────────────────────────────────────────
***REMOVED*** 2. All 12 sections present
***REMOVED*** ──────────────────────────────────────────────────────────────────────────
sections = [
...
***REMOVED*** ──────────────────────────────────────────────────────────────────────────
***REMOVED*** 3. Section 3 (deepDive) intro opens with GEO-style definition
***REMOVED*** ──────────────────────────────────────────────────────────────────────────
***REMOVED*** Find deepDive intro
dd_match = re.search(r'deepDive:\s*\{[^}]*?intro:\s*\[(.*?)\]', body_text, re.DOTALL)
dd_intro = dd_match.group(1) if dd_match else ""
***REMOVED*** Also check hero.geoDefinition exists
...
***REMOVED*** ──────────────────────────────────────────────────────────────────────────
***REMOVED*** 4. FAQ "What is [concept]?" question
***REMOVED*** ──────────────────────────────────────────────────────────────────────────
...
***REMOVED*** ──────────────────────────────────────────────────────────────────────────
***REMOVED*** 5. Internal links count (HTML <a href="..."> in body copy)
***REMOVED*** ──────────────────────────────────────────────────────────────────────────
***REMOVED*** Only count inline HTML anchors (the "woven into body copy" links)
***REMOVED*** NOTE: Inside TypeScript double-quoted strings, the quotes are escaped as \"
***REMOVED*** so the on-disk text is <a href=\"/services/ai/automation\">
inline_links = re.findall(r'<a href=\\?"([^"\\]+)\\?"', body_text)
***REMOVED*** Filter out external
...
***REMOVED*** ──────────────────────────────────────────────────────────────────────────
***REMOVED*** 6. First 200 words contains a Cluster-to-Pillar link
***REMOVED*** ──────────────────────────────────────────────────────────────────────────
***REMOVED*** Check if any of the inline links appears in the first ~200 words of body
first_chunk = " ".join(words[:300])  ***REMOVED*** ~300 words to be safe
...
forbidden = [
    ...
    "unlock", "empower",  ***REMOVED*** allowed only when describing concrete action; flag any
]
found_forbidden = []
...
***REMOVED*** ──────────────────────────────────────────────────────────────────────────
***REMOVED*** 8. Sentence length (≤ 28 words) — only body paragraphs
***REMOVED*** ──────────────────────────────────────────────────────────────────────────
***REMOVED*** Pull only the multi-paragraph string literals (intro/body arrays)
***REMOVED*** Crude: any string with > 80 chars and ending in period
long_strings = [s for s in strings if len(s) > 80]
violations = []
for s in long_strings:
    ***REMOVED*** Split on sentence boundaries
...
***REMOVED*** ──────────────────────────────────────────────────────────────────────────
***REMOVED*** 10. STAR case study with concrete metrics
***REMOVED*** ──────────────────────────────────────────────────────────────────────────
***REMOVED*** Check caseStudies block exists with situation/task/action/result fields
...
***REMOVED*** Check for numeric metrics in result fields
...
***REMOVED*** ──────────────────────────────────────────────────────────────────────────
***REMOVED*** 11. FAQ question count + categories
***REMOVED*** ──────────────────────────────────────────────────────────────────────────
faq_q_count = len(re.findall(r'q:\s*"', body_text))
faq_cat_count = len(re.findall(r'name:\s*"', body_text))  ***REMOVED*** rough — counts all name fields
***REMOVED*** Better: count within faq block
...
if faq_match:
    ...
    faq_cat_in_block = len(re.findall(r'categories:\s*\[', faq_block)) + \
                       len(re.findall(r'name:\s*"', faq_block))  ***REMOVED*** both name (category) + question name pattern
    ***REMOVED*** Categories are objects with name + questions — count by looking for `name:` followed by `questions:`
...
***REMOVED*** ──────────────────────────────────────────────────────────────────────────
***REMOVED*** 12. Cluster glossary terms used (AI cluster)
***REMOVED*** ──────────────────────────────────────────────────────────────────────────
ai_glossary = [
