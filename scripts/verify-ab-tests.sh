...
***REMOVED*** ─────────────────────────────────────────────────────────────────────────────
***REMOVED*** Phase 3 ***REMOVED***3 — CTA A/B Testing Framework verification script.
***REMOVED***
***REMOVED*** Runs 9 checks against the codebase to confirm the framework is wired up:
***REMOVED***   1. Database schema has the 3 A/B tables
***REMOVED***   2. Prisma shim exposes the 3 models
***REMOVED***   3. Bucketing + stats + cookie helpers exist
***REMOVED***   4. <AbTest> client component exists and imports from client-safe barrel
***REMOVED***   5. Public API routes exist (expose + bootstrap)
***REMOVED***   6. Admin CRUD API routes exist
***REMOVED***   7. Admin UI page + client component exist
***REMOVED***   8. Middleware stamps the visitor cookie
***REMOVED***   9. Contact route fires conversion events
***REMOVED***  10. <AbTest> is wired into navbar + CTA section
***REMOVED*** ─────────────────────────────────────────────────────────────────────────────
...
echo "Phase 3 ***REMOVED***3 — CTA A/B Testing Framework verification"
echo "===================================================="
...
***REMOVED*** ─── 4. AbTest client component ─────────────────────────────────────────────
echo ""
...
***REMOVED*** ─── 8. Middleware cookie stamping ──────────────────────────────────────────
echo ""
...
***REMOVED*** ─── 9. Contact route conversion tracking ───────────────────────────────────
echo ""
...
if grep -q "fireAbConversion" src/app/api/contact/route.ts; then
  ...
  ***REMOVED*** 1 definition + 3 call sites = 4 expected occurrences
  if [ "$COUNT" -ge 4 ]; then
...
***REMOVED*** ─── 10. AbTest wired into CTAs ─────────────────────────────────────────────
echo ""
...
***REMOVED*** ─── 11. Admin sidebar + permissions ────────────────────────────────────────
echo ""
