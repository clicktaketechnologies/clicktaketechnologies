...
***REMOVED*** Brand palette — matches the gradient used in globals.css gradient-bg
BG_TOP = (10, 10, 20)      ***REMOVED*** near-black navy
BG_BOTTOM = (19, 35, 84)   ***REMOVED*** deep blue
ACCENT_1 = (19, 109, 255)  ***REMOVED*** ***REMOVED***136DFF brand blue
ACCENT_2 = (124, 58, 237)  ***REMOVED*** purple
TEXT_LIGHT = (245, 247, 255)
TEXT_MUTED = (180, 190, 220)

***REMOVED*** Fonts (use what's installed; fall back gracefully)
...
def main():
    ...
    ***REMOVED*** Vertical gradient background
    for y in range(H):
        t = y / H
        color = lerp(BG_TOP, BG_BOTTOM, t)
        draw.line([(0, y), (W, y)], fill=color)

    ***REMOVED*** Accent bar at top
    draw.rectangle([(0, 0), (W, 8)], fill=ACCENT_1)

    ***REMOVED*** Diagonal accent stripes (subtle, top-right)
    for i, x in enumerate(range(900, 1300, 40)):
        alpha_color = lerp(ACCENT_1, ACCENT_2, i / 10)
        ***REMOVED*** Make it semi-transparent-looking by darkening toward bg
        faded = lerp(alpha_color, BG_BOTTOM, 0.6)
        draw.polygon([(x, 0), (x + 80, 0), (x - 200, H), (x - 280, H)], fill=faded)

    ***REMOVED*** Logo lockup — colored square + wordmark
    logo_size = 72
    logo_x, logo_y = 80, 80
    ***REMOVED*** Gradient square — approximate with two stacked rectangles
    draw.rectangle(
    ...
    ***REMOVED*** "CT" monogram in the square
    ...
    ***REMOVED*** CTA pill at bottom-left
