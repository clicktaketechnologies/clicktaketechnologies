...
''' + ''.join(f'''
          <a href="***REMOVED***{cs[0]}" data-nav="{cs[0]}" class="tilt-card glass rounded-2xl overflow-hidden reveal group">
            <div class="aspect-video relative overflow-hidden" style="background:linear-gradient(135deg,***REMOVED***{i%2 and '136DFF' or 'FF53A9'}33,***REMOVED***{i%3 and '7B2FBE' or '136DFF'}33);">
