...
***REMOVED*** Common replacement rules — applied to ALL site pages
REPLACEMENTS = [
    ***REMOVED*** CTA buttons (Book a Call / Get Started / etc.) — gradient → solid pink squircle
    (
        ...
        'inline-flex items-center gap-2 rounded-[8px] bg-[***REMOVED***EC4899] px-5 py-2.5 text-sm font-semibold text-white hover:-translate-y-0.5 transition shrink-0'
    ),
    (
    ...
    ***REMOVED*** Hero H1 gradient text → solid
    (
    ...
    ***REMOVED*** Tech-stack pills
    (
        ...
        'inline-flex items-center rounded-[6px] border border-[***REMOVED***EC4899]/25 bg-[***REMOVED***EC4899]/8 px-3 py-1.5 text-xs font-medium text-[***REMOVED***F5F5F0]'
    ),
    ***REMOVED*** Generic backdrop-blur cards → solid
    (
    ...
    ***REMOVED*** Generic brand-blue eyebrow text
    (
        'text-brand-blue',
        'text-[***REMOVED***EC4899]'
    ),
    ***REMOVED*** Gradient buttons with rounded-xl (form submits, large CTAs)
    (
        ...
        'rounded-xl bg-[***REMOVED***EC4899] px-6 py-3 font-semibold text-white disabled:opacity-50 disabled:cursor-not-allowed hover:-translate-y-0.5 transition'
    ),
    (
    ...
    ***REMOVED*** Generic gradient icon containers (rounded-xl with text-white)
    (
        'grid h-10 w-10 place-items-center rounded-xl bg-gradient-to-r from-brand-cyan to-brand-blue text-white',
        'grid h-10 w-10 place-items-center rounded-xl bg-[***REMOVED***EC4899] text-white'
    ),
    (
...
def main():
    ...
    ***REMOVED*** All pages to patch (in priority order)
    target_files = [
        ***REMOVED*** High-impact inner pages
