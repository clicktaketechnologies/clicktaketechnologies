***REMOVED***!/bin/bash
***REMOVED*** Verify all 32 deep-dive pages have FAQ JSON-LD schema and reasonable HTML size.
set -e
cd /home/z/my-project

***REMOVED*** All 32 deep-dive pages: 24 services + 6 solutions + about + team
PAGES=(
  ***REMOVED*** AI services (5)
  "services/ai/llm"
  "services/ai/chatbots"
  "services/ai/prompt-engineering"
  "services/ai/cv-nlp"
  "services/ai/automation"
  ***REMOVED*** Web services (10)
...
for slug in "${PAGES[@]}"; do
  ...
  ***REMOVED*** Strip tags + scripts to estimate visible words
  words=$(python3 -c "
import re
