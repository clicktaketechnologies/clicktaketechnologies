...
***REMOVED*** Order matters: more specific patterns first
***REMOVED*** Use lookarounds instead of \b because [ is not a word char
W = r'(?<![\w-])'  ***REMOVED*** left boundary
E = r'(?![\w-])'   ***REMOVED*** right boundary

PATTERNS = [
    ***REMOVED*** hover:bg-white variants (must come before plain bg-white)
    ...
    ***REMOVED*** bg-white variants (translucent surface tints)
...
SKIP_FILES = []  ***REMOVED*** add filenames here if they should not be touched
