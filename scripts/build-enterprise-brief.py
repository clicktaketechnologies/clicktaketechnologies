...
***REMOVED*** DejaVu Sans (body) + DejaVu Sans Bold (headings) + DejaVu Sans Mono (code)
...
pdfmetrics.registerFont(TTFont("BodyFont-Italic", f"{FONT_DIR_DEJAVU}/DejaVuSans.ttf"))  ***REMOVED*** fallback
...
***REMOVED*** Font family registration for italic/bold-italic resolution
...
***REMOVED*** ─── ClickTake Brand Palette ────────────────────────────────────────────────
***REMOVED*** Aligned with the site's --nx-* tokens for visual consistency.
PAGE_BG       = colors.HexColor("***REMOVED***FFFFFF")
SECTION_BG    = colors.HexColor("***REMOVED***F8F6FC")  ***REMOVED*** very faint lavender
CARD_BG       = colors.HexColor("***REMOVED***F1EDF8")
TABLE_STRIPE  = colors.HexColor("***REMOVED***F8F6FC")

***REMOVED*** Brand accents (ClickTake tri-stop)
BRAND_PINK    = colors.HexColor("***REMOVED***FF53A9")
BRAND_PINK_DEEP = colors.HexColor("***REMOVED***E0197A")
BRAND_BLUE    = colors.HexColor("***REMOVED***136DFF")
BRAND_PURPLE  = colors.HexColor("***REMOVED***9B3DFF")

***REMOVED*** Structural
HEADER_FILL   = colors.HexColor("***REMOVED***100820")  ***REMOVED*** dark navy for table headers
COVER_BLOCK   = colors.HexColor("***REMOVED***0A0612")  ***REMOVED*** deepest navy for cover
BORDER        = colors.HexColor("***REMOVED***E5E0EE")
BORDER_STRONG = colors.HexColor("***REMOVED***CBD0E1")

***REMOVED*** Typography
TEXT_PRIMARY  = colors.HexColor("***REMOVED***0A0612")
TEXT_SOFT     = colors.HexColor("***REMOVED***4A3B5C")
TEXT_MUTED    = colors.HexColor("***REMOVED***6E5F80")
TEXT_INVERT   = colors.HexColor("***REMOVED***F4F0FF")

***REMOVED*** Semantic
SEM_SUCCESS   = colors.HexColor("***REMOVED***10B981")
SEM_WARNING   = colors.HexColor("***REMOVED***F59E0B")
SEM_ERROR     = colors.HexColor("***REMOVED***EF4444")

***REMOVED*** ─── Page Geometry ──────────────────────────────────────────────────────────
PAGE_W, PAGE_H = A4  ***REMOVED*** 595 × 842 pt
MARGIN_L = 22 * mm
MARGIN_R = 22 * mm
MARGIN_T = 24 * mm
MARGIN_B = 22 * mm
CONTENT_W = PAGE_W - MARGIN_L - MARGIN_R  ***REMOVED*** ~ 451 pt

***REMOVED*** ─── Paragraph Styles ───────────────────────────────────────────────────────
STYLES = {
    ...
    "CoverSubtitle": ParagraphStyle(
        ...
        textColor=colors.HexColor("***REMOVED***B5A8C8"), alignment=TA_LEFT, leading=20,
        spaceAfter=24,
    ),
    "CoverFooter": ParagraphStyle(
        "CoverFooter", fontName="BodyFont", fontSize=9,
        textColor=colors.HexColor("***REMOVED***7A6B95"), alignment=TA_LEFT, leading=13,
    ),
    "CoverFooterRight": ParagraphStyle(
        "CoverFooterRight", fontName="MonoFont", fontSize=9,
        textColor=colors.HexColor("***REMOVED***7A6B95"), alignment=TA_RIGHT, leading=13,
    ),
    "H1": ParagraphStyle(
    ...
    "Callout": ParagraphStyle(
        ...
        backColor=colors.HexColor("***REMOVED***FFF0F7"),  ***REMOVED*** faint pink wash
...
***REMOVED*** ─── Helper: heading with bookmark for TOC ──────────────────────────────────
...
def callout(text, label="Key Insight"):
    ...
    inner = Paragraph(
        f'<font name="MonoFont-Bold" color="***REMOVED***FF53A9" size="8">{label.upper()}</font><br/><br/>'
        f'<font name="BodyFont" size="10" color="***REMOVED***0A0612">{text}</font>',
        STYLES["Callout"],
    )
    return inner
...
def pull_quote(text, attribution=None):
    ...
    inner = f'<font name="SerifFont" size="13" color="***REMOVED***4A3B5C">"{text}"</font>'
    if attribution:
        inner += f'<br/><br/><font name="MonoFont" size="8" color="***REMOVED***6E5F80">— {attribution}</font>'
    ***REMOVED*** Wrap in a table to get the left border
...
def code_block(text):
    ...
    ***REMOVED*** Escape HTML special chars
    escaped = text.replace("&", "&amp;").replace("<", "&lt;").replace(">", "&gt;")
    ***REMOVED*** Preserve line breaks
...
def styled_table(data, col_widths=None, header=True, stripe=True):
    ...
    ***REMOVED*** Convert all cells to Paragraphs
    wrapped = []
        ...
        for c_idx, cell in enumerate(row):
            if isinstance(cell, str):
                if r_idx == 0 and header:
                    ...
                    style = "TableCellMono"  ***REMOVED*** first column = brand-pink mono
                else:
                    style = "TableCell"
...
***REMOVED*** ─── Page Templates ─────────────────────────────────────────────────────────
def cover_page(canv, doc):
    """Dark navy cover page with brand gradient."""
    canv.saveState()
    ***REMOVED*** Full-bleed dark navy background
    canv.setFillColor(COVER_BLOCK)
    canv.rect(0, 0, PAGE_W, PAGE_H, fill=1, stroke=0)
    ***REMOVED*** Top gradient strip (pink → purple → blue) — drawn as 3 vertical bands
    band_h = 6
    ...
    ***REMOVED*** Bottom accent line (thin pink)
    canv.setFillColor(BRAND_PINK)
...
***REMOVED*** ─── DocTemplate with TOC support ───────────────────────────────────────────
...
def build_pdf(output_path):
    ...
    ***REMOVED*** ═══════════════════════════════════════════════════════════════════════
    ***REMOVED*** SECTION 1: COVER PAGE
    ***REMOVED*** ═══════════════════════════════════════════════════════════════════════
    ***REMOVED*** Use spacers to position content within the cover frame
    ...
    ***REMOVED*** Cover footer table (2 columns)
    footer_data = [[
        Paragraph(
            '<font name="MonoFont-Bold" color="***REMOVED***FF8AC4" size="8">PREPARED BY</font><br/>'
            '<font color="***REMOVED***F4F0FF" size="10">ClickTake Technologies</font><br/>'
            '<font color="***REMOVED***7A6B95" size="9">Birmingham · Multan · Austin · Dubai</font>',
            STYLES["CoverFooter"]
        ),
        Paragraph(
            '<font name="MonoFont-Bold" color="***REMOVED***FF8AC4" size="8">DATE · VERSION</font><br/>'
            '<font color="***REMOVED***F4F0FF" size="10">July 2026 · v1.0</font><br/>'
            '<font color="***REMOVED***7A6B95" size="9">12-week implementation roadmap</font>',
    ...
    ***REMOVED*** Switch to body template for the rest of the document
    story.append(NextPageTemplate("Body"))
    story.append(PageBreak())

    ***REMOVED*** ═══════════════════════════════════════════════════════════════════════
    ***REMOVED*** SECTION 2: TABLE OF CONTENTS
    ***REMOVED*** ═══════════════════════════════════════════════════════════════════════
    ...
    ***REMOVED*** ═══════════════════════════════════════════════════════════════════════
    ***REMOVED*** SECTION 3: EXECUTIVE SUMMARY
    ***REMOVED*** ═══════════════════════════════════════════════════════════════════════
    ...
    ***REMOVED*** ═══════════════════════════════════════════════════════════════════════
    ***REMOVED*** SECTION 4: PILLAR 1 — VISUAL & MOTION DESIGN
    ***REMOVED*** ═══════════════════════════════════════════════════════════════════════
    ...
    ***REMOVED*** 1.1 — 3D Asset Integration
    ...
    ***REMOVED*** ═══════════════════════════════════════════════════════════════════════
    ***REMOVED*** SECTION 5: PILLAR 2 — TECHNICAL SEO & SILO ARCHITECTURE
    ***REMOVED*** ═══════════════════════════════════════════════════════════════════════
    ...
    ***REMOVED*** 2.2 — Solution-to-Service Bridge
    ...
    ***REMOVED*** 2.3 — Contextual Resource Linking
    ...
    ***REMOVED*** ═══════════════════════════════════════════════════════════════════════
    ***REMOVED*** SECTION 6: PILLAR 3 — CONTENT STRATEGY & BRAND VOICE
    ***REMOVED*** ═══════════════════════════════════════════════════════════════════════
    ...
    ***REMOVED*** 3.1 — Vocabulary Upgrade
    ...
    ***REMOVED*** 3.2 — Industry-Specific Authority
    ...
    ***REMOVED*** 3.3 — Master AI Copywriting Prompt
    ...
    ***REMOVED*** ═══════════════════════════════════════════════════════════════════════
    ***REMOVED*** SECTION 7: ADMIN UI REDESIGN
    ***REMOVED*** ═══════════════════════════════════════════════════════════════════════
    ...
    ***REMOVED*** 4.1 — Login Button Fix
    ...
    login_fix_table = [
        ...
        ["Link color", "text-brand-blue (resolves to ***REMOVED***136DFF, low contrast on white)", "text-[***REMOVED***FF53A9] with dark: variants for AA contrast"],
        ["Background orbs", "brand-blue/20 with blur-2xl", "[***REMOVED***136DFF]/15 with blur-3xl + animate-pulse"],
    ...
    ***REMOVED*** 4.2 — Theme System
    ...
    story.append(p(
        ...
        '(background ***REMOVED***03000D, foreground ***REMOVED***F0EBF8, card ***REMOVED***0D0025) so the admin renders '
    ...
    ***REMOVED*** 4.3 — Responsive Breakpoints
    ...
    ***REMOVED*** ═══════════════════════════════════════════════════════════════════════
    ***REMOVED*** SECTION 8: IMPLEMENTATION ROADMAP
    ***REMOVED*** ═══════════════════════════════════════════════════════════════════════
    ...
    ***REMOVED*** ═══════════════════════════════════════════════════════════════════════
    ***REMOVED*** SECTION 9: SUCCESS METRICS & KPIs
    ***REMOVED*** ═══════════════════════════════════════════════════════════════════════
    ...
    ***REMOVED*** ═══════════════════════════════════════════════════════════════════════
    ***REMOVED*** SECTION 10: CONCLUSION & NEXT STEPS
    ***REMOVED*** ═══════════════════════════════════════════════════════════════════════
    ...
    story.append(p(
        '<font name="MonoFont" color="***REMOVED***6E5F80" size="8">'
