...
export const CATEGORY_STYLES: Record<string, ServiceCategoryStyle> = {
  ai: {
    gradient: "bg-[***REMOVED***EC4899]/15 text-[***REMOVED***EC4899]",
...
export const PROCESS_STEPS = [
  {
    ...
    icon: "Search",
    color: "bg-[***REMOVED***EC4899]/15 text-[***REMOVED***EC4899]",
...
export const CONTACT_METHODS = [
  ...
  },
  {
    ...
    glow: "bg-[***REMOVED***EC4899]/15 text-[***REMOVED***EC4899]",
  },
  {
    icon: "Mail",
    label: "Email Address",
...
export const ABOUT_STATS = [
  { val: "120+", label: "Projects Shipped", icon: "Code2", color: "bg-[***REMOVED***EC4899]/15 text-[***REMOVED***EC4899]" },
  { val: "80+", label: "Happy Clients", icon: "Users", color: "bg-[***REMOVED***EC4899]/15 text-[***REMOVED***EC4899]" },
