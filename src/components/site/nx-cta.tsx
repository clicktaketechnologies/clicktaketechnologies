      ...
      <div className="relative mx-auto max-w-5xl px-4 lg:px-8 text-center">
        ...
        >
          <MagneticButton
            ...
            strength={18}
            radius={90}
            className="!bg-white !text-[***REMOVED***E0197A] !px-7 !py-4 !text-sm sm:!text-base !font-black !shadow-xl"
          >
            {/* Phase 3 ***REMOVED***3 — A/B test the primary CTA copy. Variants are
          ...
          {[
            ...
            return (
              <a
                key={c.label}
                href={c.href}
                className="group rounded-2xl bg-[***REMOVED***14141A] border border-white/15 p-5 text-left hover:border-[***REMOVED***EC4899]/40 transition"
              >
