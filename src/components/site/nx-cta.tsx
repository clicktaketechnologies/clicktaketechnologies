    ...
    <section className="relative py-20 sm:py-28 overflow-hidden">
      ...
      <div className="relative mx-auto max-w-5xl px-4 lg:px-8 text-center">
        ...
        >
          <Link
            href="/contact"
            className="group inline-flex items-center justify-center gap-2 rounded-full bg-white px-7 py-4 text-sm sm:text-base font-black text-[***REMOVED***E0197A] shadow-xl hover:scale-[1.03] transition"
          >
