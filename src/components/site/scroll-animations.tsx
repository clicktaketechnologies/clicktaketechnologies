...
export function ScrollToTop() {
    ...
    return (
        <motion.button
            ...
            className="nx-fab-v5 group fixed bottom-8 right-8 z-50 grid h-12 w-12 place-items-center rounded-full border ct-divider bg-card/80 text-foreground backdrop-blur-xl transition-colors hover:border-primary/40 hover:text-primary active:scale-90"
        >
