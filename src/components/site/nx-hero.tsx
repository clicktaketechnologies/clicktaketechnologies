...
export function NxHero() {
  return (
    <section className="relative overflow-hidden nx-hero-bg pt-28 sm:pt-32 lg:pt-36 pb-20 lg:pb-28">
      ...
      {/* Floating glow orbs */}
      <div className="absolute top-20 -left-20 h-72 w-72 rounded-full bg-[***REMOVED***FF6B35]/20 blur-3xl nx-orb pointer-events-none" />
      <div
        className="absolute bottom-10 right-10 h-96 w-96 rounded-full bg-[***REMOVED***3B82F6]/25 blur-3xl nx-orb pointer-events-none"
        ...
        <div className="grid lg:grid-cols-2 gap-12 lg:gap-16 items-center">
          ...
          <div className="text-center lg:text-left">
            ...
            >
              <div className="flex items-center gap-0.5">
                {[1, 2, 3, 4, 5].map((i) => (
                  <Star key={i} className="h-3 w-3 fill-[***REMOVED***FF6B35] text-[***REMOVED***FF6B35]" />
                ))}
              </div>
            ...
            >
              <span className="inline-flex items-center gap-2">
                <span className="h-1.5 w-1.5 rounded-full bg-[***REMOVED***10B981]" />
                No upfront cost
              </span>
              <span className="inline-flex items-center gap-2">
                <span className="h-1.5 w-1.5 rounded-full bg-[***REMOVED***FF6B35]" />
                7-day kickoff
              </span>
              <span className="inline-flex items-center gap-2">
                <span className="h-1.5 w-1.5 rounded-full bg-[***REMOVED***3B82F6]" />
          ...
          >
            ...
            <div className="relative aspect-square max-w-md mx-auto">
              ...
              {/* Central glowing orb */}
              <div className="absolute inset-1/4 rounded-full bg-gradient-to-br from-[***REMOVED***FF6B35]/40 via-[***REMOVED***3B82F6]/30 to-transparent blur-2xl animate-pulse-glow" />

              {/* Center icon */}
              <div className="absolute inset-0 grid place-items-center">
                <div className="h-24 w-24 rounded-2xl bg-gradient-to-br from-[***REMOVED***FF6B35] to-[***REMOVED***E55319] grid place-items-center shadow-2xl">
              ...
              >
                <div className="flex items-center gap-2 mb-1.5">
                  <div className="h-8 w-8 rounded-lg bg-[***REMOVED***FF6B35]/20 grid place-items-center">
                    <Zap className="h-4 w-4 text-[***REMOVED***FF6B35]" />
                  </div>
              ...
              >
                <div className="flex items-center gap-2 mb-1.5">
                  <div className="h-8 w-8 rounded-lg bg-[***REMOVED***3B82F6]/20 grid place-items-center">
                    <Shield className="h-4 w-4 text-[***REMOVED***3B82F6]" />
                  </div>
              ...
              >
                <div className="flex items-center gap-2 mb-1.5">
                  <div className="h-8 w-8 rounded-lg bg-[***REMOVED***10B981]/20 grid place-items-center">
                    <Clock className="h-4 w-4 text-[***REMOVED***10B981]" />
                  </div>
              ...
              >
                <div className="flex items-center gap-2 mb-1.5">
                  <div className="h-8 w-8 rounded-lg bg-[***REMOVED***EC4899]/20 grid place-items-center">
                    <Star className="h-4 w-4 text-[***REMOVED***EC4899]" />
                  </div>
