        ...
        <div className="grid lg:grid-cols-2 gap-12 lg:gap-16 items-center">
          ...
          <div className="text-center lg:text-left">
            ...
            >
              ...
              <span className="block bg-gradient-to-r from-[***REMOVED***EC4899] via-[***REMOVED***9B3DFF] to-[***REMOVED***6366F1] bg-clip-text text-transparent">
                Intelligence,
              </span>
            ...
            >
              <Link
                ...
                style={{
                  background: "linear-gradient(135deg, ***REMOVED***3B82F6 0%, ***REMOVED***EC4899 100%)",
                }}
              >
                Book a Demo
      ...
      >
        ...
        <div className="absolute top-12 left-1/2 -translate-x-1/2">
          <div
            ...
            style={{
              background: "linear-gradient(135deg, ***REMOVED***FF53A9, ***REMOVED***EC4899)",
