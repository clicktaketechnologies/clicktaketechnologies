 ...
 * Background: ***REMOVED***0A0612 → ***REMOVED***100820 tri-stop dark with radial glows.
 */
export function NxHero() {
  ...
  return (
    ...
    >
      ...
      {/* Floating glow orbs */}
      <div className="absolute top-20 -left-20 h-72 w-72 rounded-full bg-[***REMOVED***FF53A9]/20 blur-3xl nx-orb pointer-events-none" />
      <div
        className="absolute bottom-10 right-10 h-96 w-96 rounded-full bg-[***REMOVED***136DFF]/25 blur-3xl nx-orb pointer-events-none"
        style={{ animationDelay: "3s" }}
      />
      <div
        className="absolute top-1/2 left-1/3 h-80 w-80 rounded-full bg-[***REMOVED***9B3DFF]/15 blur-3xl nx-orb pointer-events-none"
        ...
        <div className="grid lg:grid-cols-2 gap-12 lg:gap-16 items-center">
          ...
          >
            <div className="relative h-[500px] flex items-center justify-center">
              ...
              <div
                className="absolute inset-0 rounded-full border border-[***REMOVED***FF53A9]/15 pointer-events-none"
                style={{
                  width: "480px",
                  height: "480px",
              ...
              >
                <div className="absolute top-0 left-1/2 -ml-1 h-2 w-2 rounded-full bg-[***REMOVED***FF53A9] shadow-[0_0_14px_***REMOVED***FF53A9,0_0_28px_***REMOVED***FF53A9]" />
              </div>
              <div
                className="absolute inset-0 rounded-full border border-[***REMOVED***136DFF]/12 pointer-events-none"
                style={{
                  width: "560px",
                  height: "560px",
              ...
              >
                <div className="absolute bottom-0 left-1/2 -ml-1 h-1.5 w-1.5 rounded-full bg-[***REMOVED***136DFF] shadow-[0_0_12px_***REMOVED***136DFF,0_0_22px_***REMOVED***136DFF]" />
              </div>
              ...
              >
                ...
                >
                  ...
                  <div className="flex items-center gap-2.5 mb-5">
                    ...
                    <div className="ml-auto h-2 w-2 rounded-full bg-[***REMOVED***00e676] shadow-[0_0_8px_***REMOVED***00e676] animate-pulse" />
                  </div>

                  {/* Label */}
                  <div className="text-[10px] font-mono uppercase tracking-[2px] text-[***REMOVED***FF53A9] opacity-80 mb-3.5">
                    GROWTH ANALYTICS
                  </div>
                  ...
                  <div className="grid grid-cols-2 gap-2.5">
                    ...
                    >
                      <div className="text-xl font-black text-[***REMOVED***FF53A9]">98%</div>
                    ...
                    >
                      <div className="text-xl font-black text-[***REMOVED***136DFF]">2.4x</div>
                ...
                >
                  <div className="flex items-center gap-2 mb-1.5">
                    <div className="h-6 w-6 rounded-md bg-[***REMOVED***136DFF]/20 grid place-items-center">
                      <TrendingUp className="h-3.5 w-3.5 text-[***REMOVED***4A90D9]" />
                    </div>
                ...
                >
                  <div className="text-[10px] font-mono uppercase tracking-[1.5px] text-[***REMOVED***FF53A9] mb-2.5">
                    EXPERTISE
                  </div>
                  <div className="space-y-1.5">
                    {[
                      { name: "SEO", pct: 94, color: "linear-gradient(90deg,***REMOVED***FF53A9,***REMOVED***9B3DFF)" },
                      { name: "Web", pct: 91, color: "linear-gradient(90deg,***REMOVED***136DFF,***REMOVED***9B3DFF)" },
                      { name: "AI",  pct: 96, color: "linear-gradient(90deg,***REMOVED***9B3DFF,***REMOVED***FF53A9)" },
                    ].map(s => (
                ...
                >
                  <div className="flex items-center gap-2 mb-1.5">
                    <div className="h-6 w-6 rounded-md bg-[***REMOVED***00e676]/20 grid place-items-center">
                      <Activity className="h-3.5 w-3.5 text-[***REMOVED***00e676]" />
                    </div>
        ...
        >
          ...
          <div className="flex flex-wrap items-center justify-center gap-6 sm:gap-10">
            {["META PARTNER", "GOOGLE PARTNER", "SHOPIFY", "TIKTOK", "CLUTCH VERIFIED", "TRUSTPILOT ★★★★★"].map(p => (
              <span
                key={p}
                className="text-xs sm:text-sm font-semibold text-white/40 hover:text-[***REMOVED***FF53A9] transition-colors cursor-default tracking-wide"
              >
                {p}
              </span>
            ))}
