...
export function NxProcess() {
  return (
    <section className="relative py-24 sm:py-32 nx-navy-gradient overflow-hidden">
      ...
      <div className="absolute top-1/4 -right-20 h-96 w-96 rounded-full bg-[***REMOVED***FF6B35]/10 blur-3xl pointer-events-none" />
      <div className="absolute bottom-1/4 -left-20 h-96 w-96 rounded-full bg-[***REMOVED***3B82F6]/10 blur-3xl pointer-events-none" />
      ...
      <div className="relative mx-auto max-w-6xl px-4 lg:px-8">
        ...
        <div className="max-w-3xl mx-auto text-center">
          <motion.div
            ...
            viewport={{ once: true }}
            className="inline-flex items-center gap-2 nx-eyebrow text-[***REMOVED***FF8A5C]"
          >
            <span className="h-1 w-8 rounded-full bg-[***REMOVED***FF6B35]" />
            How we work
          </motion.div>
          <motion.h2
              ...
              return (
                ...
                >
                  ...
                  <div className="absolute left-4 sm:left-1/2 -translate-x-1/2 z-10">
                    <div
                      className="h-3 w-3 rounded-full ring-4 ring-[***REMOVED***0F1A35]"
