...
export function Glitch404() {
  ...
  return (
    <main className="relative min-h-screen overflow-hidden bg-[***REMOVED***0a0612] text-white">
        ...
        >
          <div className="relative">
            ...
            <input
              ...
              className="w-full rounded-full border border-white/15 bg-white/5 py-3 pl-10 pr-4 text-sm text-white placeholder:text-white/40 backdrop-blur focus:border-[***REMOVED***FF53A9] focus:outline-none focus:ring-2 focus:ring-[***REMOVED***FF53A9]/30"
            ...
            <AnimatePresence mode="popLayout">
              {filteredLinks.map((link) => (
                ...
                >
                  <Link
                    href={link.href}
                    className="group flex flex-col items-start rounded-xl border border-white/10 bg-white/5 p-3 text-left transition-all hover:border-[***REMOVED***FF53A9]/40 hover:bg-[***REMOVED***FF53A9]/5"
                  >
                    <span className="text-sm font-semibold text-white group-hover:text-[***REMOVED***FF8AC4]">
                      {link.label}
                    </span>
