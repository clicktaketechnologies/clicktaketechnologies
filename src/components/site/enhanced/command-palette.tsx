      ...
      <AnimatePresence>
        {open && (
          ...
          >
            ...
            {/* Modal */}
            <motion.div
              className="relative w-full max-w-xl overflow-hidden rounded-2xl border border-white/10 bg-[***REMOVED***0a0612]/95 shadow-2xl shadow-black/60"
                      ...
                      return (
                        <button
                          ...
                          className={`group flex w-full items-center gap-3 rounded-lg px-3 py-2.5 text-left transition-colors ${
                            isActive
                              ? "bg-[***REMOVED***FF53A9]/15 text-white"
                              : "text-white/80 hover:bg-white/5"
                          }`}
                        >
                          <span
                            className={`grid h-8 w-8 shrink-0 place-items-center rounded-md ${
                              isActive ? "bg-[***REMOVED***FF53A9]/20 text-[***REMOVED***FF8AC4]" : "bg-white/5 text-white/60"
                            }`}
                          >
