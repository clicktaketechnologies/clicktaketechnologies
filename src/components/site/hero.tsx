  ...
  return (
    <section id="home" className="relative min-h-screen overflow-hidden pt-28 sm:pt-32 pb-16">
      ...
      <div className="absolute inset-0 -z-10 pointer-events-none">
        ...
        <div className="absolute -top-32 -left-32 h-[28rem] w-[28rem] rounded-full bg-[***REMOVED***136DFF]/20 blur-[60px] animate-pulse-glow" />
        <div
          className="absolute top-1/3 -right-32 h-[24rem] w-[24rem] rounded-full bg-[***REMOVED***FF53A9]/20 blur-[60px] animate-pulse-glow"
