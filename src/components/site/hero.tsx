...
const Hero3D = dynamic(() => import("./hero-3d").then(m => m.Hero3D), {
  ...
  loading: () => (
    <div className="grid h-full w-full place-items-center">
      <div className="h-32 w-32 rounded-full bg-gradient-to-tr from-[***REMOVED***136DFF]/30 to-[***REMOVED***FF53A9]/30 blur-2xl animate-pulse-glow" />
    </div>
  ),
});
  ...
  return (
    <section id="home" className="relative min-h-screen overflow-hidden pt-32 pb-16">
      ...
      <div className="absolute inset-0 -z-10 pointer-events-none">
        ...
        <div className="absolute -top-32 -left-32 h-[36rem] w-[36rem] rounded-full bg-[***REMOVED***136DFF]/20 blur-[120px] animate-pulse-glow" />
        <div
          className="absolute top-1/3 -right-32 h-[32rem] w-[32rem] rounded-full bg-[***REMOVED***FF53A9]/20 blur-[120px] animate-pulse-glow"
      ...
      <div className="relative mx-auto grid max-w-7xl grid-cols-1 items-center gap-8 px-4 lg:grid-cols-2 lg:gap-12">
        ...
        <div className="relative z-10 text-center lg:text-left">
          <SectionReveal variant="fadeUp">
            <div className="inline-flex items-center gap-2 rounded-full border border-white/10 bg-white/[0.03] px-4 py-1.5 text-xs font-medium text-muted-foreground backdrop-blur-xl">
              <span className="relative flex h-2 w-2">
                <span className="absolute inline-flex h-full w-full animate-ping rounded-full bg-[***REMOVED***FF53A9] opacity-75" />
                <span className="relative inline-flex h-2 w-2 rounded-full bg-[***REMOVED***FF53A9]" />
              </span>
              <Sparkles className="h-3.5 w-3.5 text-[***REMOVED***FF53A9]" />
              <span>AI-powered agency · UK · Pakistan · USA · Dubai</span>
            </div>
          </SectionReveal>

          <SectionReveal variant="fadeUp" delay={0.1}>
            <h1 className="mt-8 text-4xl sm:text-6xl lg:text-7xl font-black tracking-tight leading-[1.05]">
          ...
          <SectionReveal variant="fadeUp" delay={0.3}>
            <div className="mt-8 flex flex-col sm:flex-row gap-3 justify-center lg:justify-start">
              <a
                href="***REMOVED***contact"
                className="inline-flex items-center justify-center gap-2 rounded-full gradient-bg px-7 py-3.5 text-sm font-semibold text-white shadow-xl hover:scale-[1.03] transition glow-brand"
              >
                Start your project <ArrowUpRight className="h-4 w-4" />
              </a>
              <a
                href="***REMOVED***work"
                className="inline-flex items-center justify-center gap-2 rounded-full border border-white/15 bg-white/[0.03] px-7 py-3.5 text-sm font-semibold backdrop-blur-xl hover:bg-white/[0.07] transition"
              >
          ...
          <SectionReveal variant="fadeUp" delay={0.4}>
            <div className="mt-10 flex flex-wrap items-center justify-center lg:justify-start gap-x-6 gap-y-2 text-sm text-muted-foreground">
              <div className="flex items-center gap-1">
                {[...Array(5)].map((_, i) => (
                  <Star key={i} className="h-4 w-4 fill-[***REMOVED***FF53A9] text-[***REMOVED***FF53A9]" />
                ))}
        ...
        {/* Right: 3D scene */}
        <SectionReveal variant="zoomIn" delay={0.3} className="relative h-[360px] sm:h-[480px] lg:h-[600px]">
          <div className="absolute inset-0 rounded-3xl bg-gradient-to-tr from-[***REMOVED***136DFF]/20 to-[***REMOVED***FF53A9]/20 blur-3xl opacity-60" />
      ...
      <SectionReveal variant="fadeUp" delay={0.2} className="mt-16 lg:mt-24 mx-auto max-w-7xl px-4">
        <div className="grid grid-cols-2 md:grid-cols-4 gap-4">
          {STATS.map((s) => {
            ...
            return (
              <div
                key={s.label}
                className="rounded-2xl glass p-6 text-center hover:border-white/20 transition"
              >
