    ...
    <div className="relative h-full w-full overflow-hidden">
      ...
      <div className="absolute inset-0">
        <div
          ...
          style={{
            background: "radial-gradient(circle, ***REMOVED***136DFF 0%, transparent 70%)",
        ...
        <div
          ...
          style={{
            background: "radial-gradient(circle, ***REMOVED***FF53A9 0%, transparent 70%)",
        ...
        <div
          ...
          style={{
            background: "radial-gradient(circle, ***REMOVED***8B5CF6 0%, transparent 70%)",
      ...
      <div className="absolute left-1/2 top-1/2 -translate-x-1/2 -translate-y-1/2">
        <div
          className="h-32 w-32 rounded-full bg-gradient-to-tr from-[***REMOVED***136DFF] to-[***REMOVED***FF53A9] opacity-80 blur-2xl"
