      ...
      <div className="mx-auto max-w-7xl px-4">
        <div className="flex flex-col md:flex-row md:items-end md:justify-between gap-6">
          ...
          <SectionReveal variant="slideRight" delay={0.15}>
            <Link
              href="/portfolio"
              className="group inline-flex items-center gap-2 rounded-full border ct-divider ct-surface px-5 py-2.5 text-sm font-medium backdrop-blur-xl transition-all duration-300 hover:border-[***REMOVED***136DFF]/30 ct-hover"
            >
              View all projects
