  ...
  return (
    <section id="work" className="relative py-24 sm:py-32 overflow-hidden">
      ...
      <div className="absolute inset-0 -z-10 pointer-events-none overflow-hidden">
        <div className="absolute left-1/4 top-0 h-[28rem] w-[28rem] rounded-full bg-[***REMOVED***136DFF]/10 blur-[120px]" />
        <div className="absolute bottom-0 right-0 h-[28rem] w-[28rem] rounded-full bg-[***REMOVED***FF53A9]/10 blur-[120px]" />
      </div>
      ...
      <div className="mx-auto max-w-7xl px-4">
        <div className="flex flex-col md:flex-row md:items-end md:justify-between gap-6">
          <div className="max-w-2xl">
            <SectionReveal variant="fadeUp">
              <div className="inline-flex items-center gap-2 rounded-full border border-white/10 bg-white/[0.03] px-4 py-1.5 text-xs font-medium text-muted-foreground">
                <span className="h-1.5 w-1.5 animate-pulse rounded-full bg-[***REMOVED***136DFF]" />
                Featured work
              </div>
            </SectionReveal>
          ...
          <SectionReveal variant="slideRight" delay={0.15}>
            <Link
              href="/portfolio"
              className="group inline-flex items-center gap-2 rounded-full border border-white/10 bg-white/[0.03] px-5 py-2.5 text-sm font-medium backdrop-blur-xl transition-all duration-300 hover:border-[***REMOVED***136DFF]/30 hover:bg-white/[0.06]"
            >
              View all projects
