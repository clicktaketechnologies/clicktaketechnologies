...
export function NxServices() {
  ...
  return (
    <section id="services" className="py-24 sm:py-32 bg-[***REMOVED***F8FAFC]">
      <div className="mx-auto max-w-7xl px-4 lg:px-8">
        ...
        <div className="max-w-3xl mx-auto text-center">
          ...
          <motion.p
            ...
            className="mt-5 text-base sm:text-lg text-[***REMOVED***475569] leading-relaxed"
          >
              ...
              <button
                ...
                className={`group inline-flex items-center gap-2 rounded-full px-4 sm:px-5 py-2.5 text-xs sm:text-sm font-semibold transition-all border ${
                  isActive
                    ...
                    : "text-[***REMOVED***475569] border-[***REMOVED***E2E8F0] bg-white hover:border-[***REMOVED***CBD5E1] hover:text-[***REMOVED***0A1124]"
                }`}
            ...
            {filtered.slice(0, 9).map((s, i) => {
              ...
              return (
                ...
                >
                  <Link
                    href={href}
                    className={`group h-full p-6 flex flex-col rounded-2xl border border-[***REMOVED***E2E8F0] bg-white hover:shadow-xl hover:-translate-y-1 hover:border-[***REMOVED***FF6B35]/40 transition-all ${
                  ...
                  >
                    ...
                    {/* Title */}
                    <h3 className={`font-bold text-[***REMOVED***0A1124] ${isFeatured ? "text-xl sm:text-2xl" : "text-base sm:text-lg"}`}>
                      {s.title}
                    </h3>

                    {/* Description */}
                    <p className="mt-2 text-sm text-[***REMOVED***475569] leading-relaxed line-clamp-3 flex-1">
                      {s.description}
                    </p>

                    {/* Footer row with "Learn more" arrow */}
                    <div className="mt-5 flex items-center justify-between pt-4 border-t border-[***REMOVED***E2E8F0]">
                      <span className="text-xs font-semibold text-[***REMOVED***94A3B8] nx-eyebrow">
                        Learn more
                      </span>
                      <span
