...
function inputClass(hasError: boolean): string {
  ...
  const base =
    "w-full rounded-xl border bg-background px-4 py-2.5 text-sm placeholder:text-muted-foreground/60 transition focus:outline-none focus:ring-2 focus:ring-[***REMOVED***136DFF]/30";
  const border = hasError ? "border-red-500/60" : "border-border focus:border-[***REMOVED***136DFF]";
  return `${base} ${border}`;
}
