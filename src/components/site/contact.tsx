  ...
  return (
    <section id="contact" className="relative py-20 sm:py-24 lg:py-32">
      <div className="absolute inset-0 -z-10 pointer-events-none">
        <div className="absolute top-0 right-1/4 h-[32rem] w-[32rem] rounded-full bg-[***REMOVED***136DFF]/10 blur-[120px]" />
        <div className="absolute bottom-0 left-1/4 h-[28rem] w-[28rem] rounded-full bg-[***REMOVED***FF53A9]/10 blur-[120px]" />
      </div>
        ...
        <div className="grid lg:grid-cols-2 gap-10 lg:gap-16 items-start">
          ...
          <div>
            <SectionReveal variant="fadeUp">
              <div className="inline-flex items-center gap-2 rounded-full border border-white/10 bg-white/[0.03] px-4 py-1.5 text-xs font-medium text-muted-foreground">
                <span className="h-1.5 w-1.5 rounded-full bg-[***REMOVED***136DFF]" />
                Get in touch
              </div>
            </SectionReveal>
              ...
              <SectionReveal variant="slideLeft" delay={0}>
                ...
                >
                  ...
                  <div className="min-w-0 flex-1">
                    ...
                    <div className="text-sm font-bold group-hover:text-[***REMOVED***136DFF] transition truncate">
                      {SITE.email}
                    </div>
                  </div>
                ...
                <SectionReveal key={p.href} variant="slideLeft" delay={(i + 1) * 0.05}>
                  ...
                  >
                    ...
                    <div className="min-w-0 flex-1">
                      ...
                      <div className="text-sm font-bold group-hover:text-[***REMOVED***136DFF] transition">
                        {p.value}
                      </div>
                    </div>
                    <ArrowUpRight className="ml-auto h-5 w-5 text-muted-foreground group-hover:text-foreground transition shrink-0" />
          ...
          <SectionReveal variant="zoomIn" delay={0.1}>
            <div className="relative rounded-3xl glass-strong p-6 sm:p-8 lg:p-10 shadow-2xl overflow-hidden">
              ...
              <div className="absolute -top-24 -right-24 h-64 w-64 rounded-full bg-gradient-to-br from-[***REMOVED***136DFF]/20 to-[***REMOVED***FF53A9]/20 blur-3xl pointer-events-none" />
              ...
              <div className="relative">
                ...
                <div className="mt-4 flex flex-wrap items-center gap-x-4 gap-y-1.5 text-[11px] text-muted-foreground">
                  <span className="inline-flex items-center gap-1.5"><Clock className="h-3 w-3 text-[***REMOVED***136DFF]" /> 24-hour response</span>
                  <span className="inline-flex items-center gap-1.5"><CheckCircle2 className="h-3 w-3 text-emerald-500" /> Free 30-min consult</span>
                  <span className="inline-flex items-center gap-1.5"><Calendar className="h-3 w-3 text-[***REMOVED***FF53A9]" /> Book a call slot</span>
                </div>
...
function inputClass(hasError: boolean): string {
  const base =
    "w-full rounded-xl border bg-white/[0.03] px-4 py-2.5 text-sm placeholder:text-muted-foreground/60 transition focus:outline-none focus:ring-2 focus:ring-[***REMOVED***136DFF]/30";
  const border = hasError ? "border-red-500/60" : "border-white/10 focus:border-[***REMOVED***136DFF]";
  return `${base} ${border}`;
}
