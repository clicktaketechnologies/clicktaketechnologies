        ...
        <SectionReveal variant="fadeUp" delay={0.3}>
          <div className="mt-8 sm:mt-10 flex flex-col sm:flex-row gap-3 justify-center">
            ...
            <a
              ...
              className="inline-flex items-center justify-center gap-2 rounded-xl bg-[***REMOVED***25D366] px-7 py-4 text-sm sm:text-base font-bold text-white shadow-xl hover:scale-[1.03] transition"
            >
