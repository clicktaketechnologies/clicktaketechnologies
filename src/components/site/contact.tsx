              ...
              >
                <div className="grid sm:grid-cols-2 gap-4">
                  <div>
                    ...
                    <input
                      ...
                      className="mt-2 w-full rounded-xl border border-white/10 bg-white/[0.03] px-4 py-3 text-sm placeholder:text-muted-foreground/60 focus:outline-none focus:border-[***REMOVED***136DFF] focus:ring-2 focus:ring-[***REMOVED***136DFF]/30 transition"
                    />
                  </div>
                  <div>
                    <label className="text-xs font-semibold uppercase tracking-widest text-muted-foreground">
                ...
                <div className="grid sm:grid-cols-2 gap-4">
                  ...
                  <div>
                    ...
                    <select
                      required
                      className="mt-2 w-full rounded-xl border border-white/10 bg-white/[0.03] px-4 py-3 text-sm focus:outline-none focus:border-[***REMOVED***136DFF] focus:ring-2 focus:ring-[***REMOVED***136DFF]/30 transition"
                    >
                ...
                <div>
                  ...
                  <textarea
                    ...
                    className="mt-2 w-full rounded-xl border border-white/10 bg-white/[0.03] px-4 py-3 text-sm placeholder:text-muted-foreground/60 focus:outline-none focus:border-[***REMOVED***136DFF] focus:ring-2 focus:ring-[***REMOVED***136DFF]/30 transition resize-none"
                  />
                </div>
