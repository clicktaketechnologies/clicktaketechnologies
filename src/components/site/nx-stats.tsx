          ...
          {STATS.map((s, i) => {
            ...
            return (
              <motion.div
                ...
                className="relative p-6 sm:p-8 rounded-2xl border border-[***REMOVED***E2E8F0] bg-gradient-to-br from-white to-[***REMOVED***F8FAFC] hover:shadow-xl hover:-translate-y-1 transition-all overflow-hidden group"
              >
                ...
                <div className="relative mt-2 text-sm sm:text-base font-bold text-[***REMOVED***0A1124]">
                  {s.label}
                </div>
                <div className="relative mt-1 text-xs sm:text-sm text-[***REMOVED***64748B] leading-relaxed">
                  {s.sub}
                </div>
              </motion.div>
            );
