            ...
            return (
              <motion.div
                ...
                className={`relative p-5 sm:p-6 rounded-2xl border nx-surface overflow-hidden transition-colors ${
                  isOpen ? "border-[***REMOVED***FF53A9]/40" : "nx-bd"
                }`}
              >
                <button
                ...
                >
                  <h3 className="text-base sm:text-lg font-bold nx-text group-hover:text-[***REMOVED***FF53A9] transition">
                    {f.q}
                  </h3>
                  <div
                    className={`h-8 w-8 rounded-full grid place-items-center shrink-0 transition-colors ${
                      isOpen
                        ? "bg-[***REMOVED***FF53A9] text-white"
