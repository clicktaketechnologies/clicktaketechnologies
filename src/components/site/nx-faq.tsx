      ...
      <div className="mx-auto max-w-4xl px-4 lg:px-8">
        ...
        <div className="text-center">
          ...
          <motion.p
            ...
            className="mt-4 text-base sm:text-lg text-[***REMOVED***475569]"
          >
            Still unsure?{" "}
            <a
              href="/contact"
            ...
            return (
              <motion.div
                ...
                className={`relative p-5 sm:p-6 rounded-2xl border bg-white overflow-hidden transition-colors ${
                  isOpen ? "border-[***REMOVED***FF6B35]/40" : "border-[***REMOVED***E2E8F0]"
                }`}
              >
                <button
                ...
                >
                  <h3 className="text-base sm:text-lg font-bold text-[***REMOVED***0A1124] group-hover:text-[***REMOVED***FF6B35] transition">
                    {f.q}
                  </h3>
                  <div
                    className={`h-8 w-8 rounded-full grid place-items-center shrink-0 transition-colors ${
                      isOpen
                        ? "bg-[***REMOVED***FF6B35] text-white"
                        : "bg-[***REMOVED***F1F5F9] text-[***REMOVED***475569]"
                    }`}
                  >
                ...
                <AnimatePresence>
                  {isOpen && (
                    ...
                    >
                      <p className="pb-2 text-sm sm:text-base text-[***REMOVED***475569] leading-relaxed">
                        {f.a}
                      </p>
                    </motion.div>
                  )}
