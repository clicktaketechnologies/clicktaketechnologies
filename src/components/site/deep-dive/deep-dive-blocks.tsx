        ...
        return (
          <div key={i}>
            ...
            >
              ...
              <ChevronDown
                className={`h-4 w-4 shrink-0 text-[***REMOVED***FF8AC4] transition-transform ${isOpen ? "rotate-180" : ""}`}
              />
            </button>
...
export function PullQuote({
  ...
  return (
    <blockquote className="relative my-8 rounded-2xl border-l-4 border-[***REMOVED***FF53A9] bg-gradient-to-r from-[***REMOVED***FF53A9]/10 to-transparent px-6 py-5 sm:px-8 sm:py-6">
      <Quote className="absolute top-4 right-4 h-6 w-6 text-[***REMOVED***FF53A9]/30" />
  ...
  return (
    <article className="rounded-2xl border border-white/10 bg-white/[0.02] p-6 sm:p-8">
      <header className="flex items-center justify-between mb-5">
        ...
        <span className="rounded-full bg-[***REMOVED***FF53A9]/15 px-3 py-1 text-xs font-mono uppercase tracking-wider text-[***REMOVED***FF8AC4]">
          Case Study
        </span>
      </header>
      <dl className="space-y-4">
        {rows.map((r) => (
          <div key={r.label} className="grid sm:grid-cols-[110px_1fr] gap-2 sm:gap-4">
            <dt className="text-xs font-mono uppercase tracking-wider text-[***REMOVED***FF8AC4] pt-0.5">
              {r.label}
            </dt>
...
export function UseCaseCard({
  ...
  return (
    <article className="group relative rounded-2xl border border-white/10 bg-white/[0.02] p-6 hover:border-[***REMOVED***FF53A9]/40 hover:bg-white/[0.04] transition">
      ...
      <dl className="space-y-3 text-sm">
        ...
        <div>
          <dt className="text-xs font-mono uppercase tracking-wider text-[***REMOVED***FF8AC4] mb-1">Result</dt>
    ...
    <div className="relative grid sm:grid-cols-[auto_1fr] gap-4 sm:gap-6">
      ...
      <div className="pb-8">
        <div className="flex flex-wrap items-baseline gap-x-3 gap-y-1 mb-2">
          <span className="text-xs font-mono uppercase tracking-wider text-[***REMOVED***FF8AC4]">
            {phase}
          </span>
  ...
  return (
    <div className="grid gap-6 sm:grid-cols-2 lg:grid-cols-3">
      {categories.map((cat) => (
        ...
        >
          <h4 className="text-sm font-mono uppercase tracking-wider text-[***REMOVED***FF8AC4] mb-4">
            {cat.name}
          </h4>
