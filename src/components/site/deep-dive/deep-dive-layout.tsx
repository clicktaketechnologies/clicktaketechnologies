  ...
  return (
    <>
              ...
              return (
                <a
                  ...
                  className={`block border-l-2 -ml-px px-3 py-1.5 text-sm transition ${
                    isActive
                      ? "border-[***REMOVED***FF53A9] text-white font-medium"
      ...
      <button
        ...
        className="xl:hidden fixed bottom-6 right-6 z-40 flex h-12 w-12 items-center justify-center rounded-full bg-gradient-to-br from-[***REMOVED***FF53A9] to-[***REMOVED***136DFF] text-white shadow-lg shadow-[***REMOVED***FF53A9]/30"
...
function SectionHeading({
  ...
  return (
    <header className="mb-10 max-w-3xl">
      {eyebrow && (
        <div className="mb-3 inline-flex items-center gap-2 text-xs font-mono uppercase tracking-[2px] text-[***REMOVED***FF8AC4]">
        ...
        <div className="flex gap-12">
          ...
          <article className="flex-1 min-w-0 max-w-4xl mx-auto xl:mx-0">
                  ...
                  {content.deepDive.subsections.map((sub, i) => (
                    <div key={i}>
                      <h3 className="text-xl font-bold text-white mb-3 flex items-baseline gap-3">
                        <span className="text-sm font-mono text-[***REMOVED***FF8AC4]">
                      ...
                      {sub.jargon && sub.jargon.length > 0 && (
                        <dl className="mt-4 grid sm:grid-cols-2 gap-3">
                          {sub.jargon.map((t) => (
                            ...
                            >
                              <dt className="text-sm font-bold text-[***REMOVED***FF8AC4] mb-1">
                                {t.term}
                              </dt>
              ...
              <Section id={slugify(content.businessImpact.title)} divider>
                ...
                <div className="grid grid-cols-2 lg:grid-cols-4 gap-4 mb-8">
                  {content.businessImpact.metrics.map((m, i) => (
                    <div
                      key={i}
                      className="rounded-2xl border border-white/10 bg-gradient-to-br from-[***REMOVED***FF53A9]/10 to-transparent p-5 text-center"
                    >
                      <div className="text-3xl sm:text-4xl font-black text-white nx-stat-num">
                        {m.value}
                      </div>
                      <div className="mt-1 text-xs font-mono uppercase tracking-wider text-[***REMOVED***FF8AC4]">
                        {m.label}
                      </div>
              ...
              <Section id={slugify(content.integrations.title)} divider>
                ...
                <div className="space-y-6">
                  {content.integrations.categories.map((cat) => (
                    <div key={cat.name}>
                      <h3 className="text-sm font-mono uppercase tracking-wider text-[***REMOVED***FF8AC4] mb-3">
                        {cat.name}
                      </h3>
            ...
            <Section id={slugify(content.finalCta.title)} divider>
              <div className="relative overflow-hidden rounded-3xl border border-[***REMOVED***FF53A9]/20 bg-gradient-to-br from-[***REMOVED***FF53A9]/15 via-[***REMOVED***9B3DFF]/10 to-[***REMOVED***136DFF]/15 p-8 sm:p-12 text-center">
                ...
                <div className="relative">
                  ...
                  <div className="mt-10 grid sm:grid-cols-3 gap-4 max-w-3xl mx-auto">
                    {content.finalCta.steps.map((s, i) => (
                      ...
                      >
                        <div className="text-xs font-mono text-[***REMOVED***FF8AC4] mb-2">
                          Step {s.step}
                        </div>
