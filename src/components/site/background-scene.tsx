...
const LIGHT_PALETTE: [number, number, number][] = [
  [19, 109, 255],   // brand-blue ***REMOVED***136DFF
  [255, 83, 169],   // brand-pink ***REMOVED***FF53A9
  [193, 43, 255],   // brand-magenta ***REMOVED***c12bff
  [34, 211, 238],   // brand-cyan ***REMOVED***22d3ee
];
  ...
  useEffect(() => {
    ...
    const buildBg = () => {
      ...
      if (dark) {
        ...
        lg.addColorStop(0, "***REMOVED***f0f6ff");
        lg.addColorStop(0.5, "***REMOVED***eaf2fb");
        lg.addColorStop(1, "***REMOVED***e4eef8");
        bCtx.fillStyle = lg;
        bCtx.fillRect(0, 0, W, H);
    ...
    const drawFrame = (ts: number) => {
      ...
      if (bgReady && bgCanvas && bgCanvas.width > 0 && bgCanvas.height > 0 && W > 0 && H > 0) {
        try {
          ...
          bgReady = false;
          ctx.fillStyle = darkRef.current ? "***REMOVED***03000D" : "***REMOVED***f0f6ff";
