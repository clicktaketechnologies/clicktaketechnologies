...
function useBrandColors() {
  return useMemo(() => {
    ...
    return {
      pink: read('--ct-pink', '***REMOVED***FF53A9'),
      purple: read('--ct-purple', '***REMOVED***9B3DFF'),
      blue: read('--ct-blue', '***REMOVED***136DFF'),
      cyan: read('--ct-cyan', '***REMOVED***22d3ee'),
      gold: read('--ct-gold', '***REMOVED***FFD782'),
    }
  }, [])
}
  ...
  return (
    <group position={[0, 0, z]} scale={scale}>
      ...
      <mesh position={[-0.22, 0.18, 0]}>
        ...
        <meshStandardMaterial color="***REMOVED***0a0e1a" emissive="***REMOVED***0a0e1a" emissiveIntensity={0.3} />
      </mesh>
      {/* Right eye */}
      <mesh position={[0.22, 0.18, 0]}>
        <sphereGeometry args={[0.08, 16, 16]} />
      ...
      <mesh position={[-0.22, 0.20, 0.02]}>
        ...
        <meshBasicMaterial color="***REMOVED***ffffff" />
      </mesh>
      <mesh position={[0.22, 0.20, 0.02]}>
        <sphereGeometry args={[0.025, 12, 12]} />
        <meshBasicMaterial color="***REMOVED***ffffff" />
      ...
      <mesh position={[0, -0.15, 0]} rotation={[0, 0, 0]}>
        ...
        <meshStandardMaterial color="***REMOVED***0a0e1a" />
      </mesh>
    </group>
  )
}
      ...
      {variant === 'services' && (
        <group>
          ...
          <mesh position={[-0.2, 0, 0.51]}>
            ...
            <meshStandardMaterial color="***REMOVED***ffffff" emissive="***REMOVED***ffffff" emissiveIntensity={0.4} />
          </mesh>
          <mesh position={[0.2, 0, 0.51]}>
            <boxGeometry args={[0.05, 0.25, 0.01]} />
            <meshStandardMaterial color="***REMOVED***ffffff" emissive="***REMOVED***ffffff" emissiveIntensity={0.4} />
      ...
      {variant === 'about' && (
        <group>
          ...
          <mesh position={[-0.18, -0.05, 0.13]} rotation={[0, 0, Math.PI / 4]}>
            ...
            <meshStandardMaterial color="***REMOVED***ffffff" emissive="***REMOVED***ffffff" emissiveIntensity={0.5} />
          </mesh>
      ...
      {variant === 'blog' && (
        <group>
          ...
          <mesh position={[-0.3, 0.04, 0]} rotation={[0, Math.PI / 8, 0]}>
            ...
            <meshStandardMaterial color="***REMOVED***ffffff" />
          </mesh>
          <mesh position={[0.3, 0.04, 0]} rotation={[0, -Math.PI / 8, 0]}>
            <boxGeometry args={[0.35, 0.005, 0.5]} />
            <meshStandardMaterial color="***REMOVED***ffffff" />
      ...
      {variant === 'pricing' && (
        <group>
          ...
          <mesh position={[-0.4, 0.3, 0]} rotation={[Math.PI / 2, 0, 0]}>
            ...
            <meshStandardMaterial color="***REMOVED***000000" />
          </mesh>
          {/* String */}
      ...
      {variant === 'portfolio' && (
        <group>
          ...
          <mesh position={[0, 0, 0.09]}>
            ...
            <meshStandardMaterial color="***REMOVED***000000" emissive={secondary} emissiveIntensity={0.3} />
          </mesh>
          {/* Stand */}
