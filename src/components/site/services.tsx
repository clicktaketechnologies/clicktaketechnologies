        ...
        <div className="max-w-3xl">
          <SectionReveal variant="fadeUp">
            <div className="inline-flex items-center gap-2 rounded-full border border-white/10 bg-white/[0.03] px-4 py-1.5 text-xs font-medium text-muted-foreground">
              <span className="h-1.5 w-1.5 rounded-full bg-[***REMOVED***FF53A9]" />
              What we do
            </div>
          </SectionReveal>
          ...
          {SERVICE_CATEGORIES.map((cat, i) => (
            ...
            >
              <div className="group relative h-full rounded-3xl glass p-8 hover:border-white/20 transition overflow-hidden">
                {/* hover glow */}
                <div className="absolute -top-20 -right-20 h-40 w-40 rounded-full bg-[***REMOVED***136DFF]/10 blur-3xl opacity-0 group-hover:opacity-100 transition" />
                <div className="absolute -bottom-20 -left-20 h-40 w-40 rounded-full bg-[***REMOVED***FF53A9]/10 blur-3xl opacity-0 group-hover:opacity-100 transition" />
                ...
                <div className="relative">
                  ...
                  <p className="mt-2 text-sm text-[***REMOVED***FF53A9] font-medium">{cat.tagline}</p>
        ...
        <SectionReveal variant="zoomIn" delay={0.1} className="mt-12">
          <div className="flex flex-col sm:flex-row items-center justify-between gap-4 rounded-3xl gradient-bg p-8 sm:p-10 text-white shadow-2xl glow-brand">
            ...
            <a
              ...
              className="inline-flex items-center gap-2 rounded-full bg-white px-7 py-3.5 text-sm font-bold text-[***REMOVED***136DFF] hover:scale-[1.03] transition shrink-0"
            >
