...
const TABS: { id: TabId; label: string; accent: string }[] = [
  ...
  { id: "web",        label: "Web & Software",    accent: "bg-[***REMOVED***EC4899]/15 text-[***REMOVED***EC4899]" },
  { id: "ai",         label: "AI Automation",     accent: "bg-[***REMOVED***EC4899]/15 text-[***REMOVED***EC4899]" },
  { id: "creative",   label: "Creative",          accent: "bg-[***REMOVED***EC4899]/15 text-[***REMOVED***EC4899]" },
  { id: "essentials", label: "Business Essentials", accent: "bg-[***REMOVED***EC4899]/15 text-[***REMOVED***EC4899]" },
];
            ...
            {TABS.map((t) => {
              ...
              return (
                ...
                >
                  {isActive && (
                    <span
                      className={`absolute inset-0 rounded-full bg-[***REMOVED***EC4899]/20`}
                      aria-hidden
                    />
                  )}
          ...
          <AnimatePresence mode="wait">
            ...
            >
              {filtered.map((s, i) => {
                ...
                const accentColor = style?.accentColor ?? "text-[***REMOVED***EC4899]";
                    ...
                    >
                      ...
                      <div className="relative flex items-start gap-4">
                        ...
                        <div className="min-w-0 flex-1">
                          ...
                          <div className="mt-4 inline-flex items-center gap-1 text-xs font-semibold text-[***REMOVED***EC4899] group-hover:gap-2 transition-all">
                            Learn More
          ...
          {active === "essentials" && STARTER_KIT && (
            <SectionReveal variant="zoomIn" delay={0.1} className="mt-8">
              <Link
                ...
                className="group relative flex flex-col sm:flex-row items-start sm:items-center justify-between gap-4 rounded-3xl bg-[***REMOVED***EC4899]/8 border border-[***REMOVED***EC4899]/25 p-6 sm:p-8 hover:bg-[***REMOVED***EC4899]/12 transition"
              >
                <div className="flex items-start gap-4 min-w-0">
                  <div className="grid h-12 w-12 shrink-0 place-items-center rounded-xl bg-[***REMOVED***EC4899]/15 text-[***REMOVED***EC4899] shadow-sm group-hover:scale-110 transition-transform">
