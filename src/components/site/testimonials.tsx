  ...
  return (
    <section id="testimonials" className="relative py-24 sm:py-32">
      <div className="absolute inset-0 -z-10 pointer-events-none">
        <div className="absolute bottom-0 left-1/2 h-[30rem] w-[60rem] -translate-x-1/2 rounded-full bg-[***REMOVED***FF53A9]/8 blur-[120px]" />
      </div>
          ...
          {TESTIMONIALS.map((t, i) => (
            ...
            >
              <figure className="relative h-full rounded-3xl glass p-8 hover:border-white/20 transition">
                <Quote className="h-8 w-8 text-[***REMOVED***FF53A9]/60" />
