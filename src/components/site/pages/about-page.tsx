        ...
        <div className="mt-12 grid gap-4 sm:grid-cols-2 lg:grid-cols-4">
          {SITE.locations.map((l, i) => (
            <motion.div
              ...
              className="group rounded-2xl border nx-bd nx-surface p-5 transition-all duration-300 hover:border-[***REMOVED***FF6B35]/40 hover:-translate-y-1"
            >
        ...
        <div className="relative overflow-hidden rounded-3xl nx-orange-gradient p-10 sm:p-14 text-center">
          ...
          <div className="relative">
            ...
            <div className="flex flex-wrap gap-3 justify-center">
              <Link
                href="/contact"
                className="inline-flex items-center gap-2 rounded-full bg-white px-7 py-3.5 font-bold text-[***REMOVED***E55319] shadow-xl hover:scale-105 transition"
              >
