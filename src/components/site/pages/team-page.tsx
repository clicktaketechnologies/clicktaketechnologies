...
const DEPT_GRADIENT: Record<string, string> = {
  Leadership: "bg-[***REMOVED***EC4899]/15 text-[***REMOVED***EC4899]",
  Development: "bg-[***REMOVED***EC4899]/15 text-[***REMOVED***EC4899]",
  Marketing: "from-emerald-500 to-teal-600",
  Creative: "bg-[***REMOVED***EC4899]/15 text-[***REMOVED***EC4899]",
  Operations: "bg-[***REMOVED***EC4899]/15 text-[***REMOVED***EC4899]",
};

function TeamCard({ member }: { member: TeamMember }) {
  const Icon = DEPT_ICON[member.department] || Users;
  const gradient = DEPT_GRADIENT[member.department] || "bg-[***REMOVED***EC4899]/15 text-[***REMOVED***EC4899]";
...
{/* Per-page 3D Story Scene — team variant. Sits behind hero content. */}
        <NxStoryScene variant="team" />
        ...
        <Nx3DScene density="low" />
          ...
          >
            {SITE.locations.map((l) => (
              <div
                key={l.country}
                className="rounded-xl border border-border bg-[***REMOVED***14141A] p-4"
              >
          ...
          <div className="mt-12 sm:mt-16">
            <div className="flex items-center gap-2 mb-4">
              <Users className="h-5 w-5 text-[***REMOVED***EC4899] shrink-0" />
