...
{/* Per-page 3D Story Scene — services variant. Sits behind hero content. */}
        <NxStoryScene variant="services" />
          ...
          <Nx3DCharacter variant="service-detail" size="md" />
        </div>
        ...
        <Nx3DScene density="low" />
          ...
          >
            ...
            <div className="grid gap-3 sm:gap-4 sm:grid-cols-2">
              {inclusions.map((inc) => (
                <div
                  key={inc}
                  className="flex items-start gap-3 rounded-xl border border-border bg-[***REMOVED***14141A] p-4 sm:p-5"
                >
          ...
          >
            ...
            <div className="grid gap-4 sm:grid-cols-2">
              {copy.benefits.map((b) => (
                <div
                  key={b.title}
                  className="rounded-xl border border-border bg-[***REMOVED***14141A] p-5 hover:border-primary/30 transition"
                >
          ...
          >
            ...
            <div className="grid sm:grid-cols-2 lg:grid-cols-4 gap-3">
              {REGION_COPY.map((r) => (
                <div
                  key={r.city}
                  className="rounded-xl border border-border bg-[***REMOVED***14141A] p-4 hover:border-primary/30 hover:bg-card/60 transition"
                >
          ...
          {related.length > 0 && (
            ...
            >
              ...
              <div className="mt-6">
                <Link
                  href="/services"
                  className="inline-flex items-center gap-2 text-sm font-medium text-[***REMOVED***EC4899] hover:underline"
                >
          ...
          <motion.section
            ...
            className="mt-12 sm:mt-16 rounded-2xl border border-border bg-[***REMOVED***14141A] p-6 sm:p-8"
          >
            <div className="flex items-center gap-2 mb-2">
              <MapPin className={`h-5 w-5 ${cat.accentColor} shrink-0`} />
              ...
              {CITIES.map((c) => {
                ...
                return (
                  ...
                  >
                    ...
                    {c.name}
                    {c.hasOffice && (
                      <span className="text-[10px] text-[***REMOVED***EC4899]/70">HQ</span>
                    )}
                  </Link>
                );
              })}
