...
const CAT_COLOR: Record<string, string> = {
  ...
  "Web Dev": "bg-[***REMOVED***EC4899]/15",
  "Digital Marketing": "bg-amber-500/15",
  "AI Automation": "bg-[***REMOVED***EC4899]/15",
  "Business Startup": "bg-[***REMOVED***EC4899]/15",
  "E-commerce": "bg-[***REMOVED***EC4899]/15",
  "Case Studies": "bg-[***REMOVED***EC4899]/15",
  "Company News": "bg-[***REMOVED***EC4899]/15",
};
...
function PostCard({ post }: { post: BlogPost }) {
  const gradient = CAT_COLOR[post.category] || "bg-[***REMOVED***EC4899]/15";
  return (
    <Link
      href={`/blog/${post.slug}`}
      className="group flex flex-col rounded-2xl border border-border bg-[***REMOVED***14141A] overflow-hidden hover:border-primary/40 hover:bg-card/60 transition"
    >
...
{/* Per-page 3D Story Scene — blog variant. Sits behind hero content. */}
        ...
        <Nx3DScene density="low" />
          ...
          {/* Posts grid */}
          {filtered.length === 0 ? (
            <div className="mt-12 rounded-2xl border border-border bg-[***REMOVED***14141A] p-10 text-center">
