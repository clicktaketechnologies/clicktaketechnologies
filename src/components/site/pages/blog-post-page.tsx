...
const CAT_COLOR: Record<string, string> = {
  ...
  "Web Dev": "bg-[***REMOVED***EC4899]/15 text-[***REMOVED***EC4899]",
  "Digital Marketing": "bg-amber-500/15 text-amber-300",
  "AI Automation": "bg-[***REMOVED***EC4899]/15 text-[***REMOVED***EC4899]",
  "Business Startup": "bg-[***REMOVED***EC4899]/15 text-[***REMOVED***EC4899]",
  "E-commerce": "bg-[***REMOVED***EC4899]/15 text-[***REMOVED***EC4899]",
  "Case Studies": "bg-[***REMOVED***EC4899]/15 text-[***REMOVED***EC4899]",
  "Company News": "bg-[***REMOVED***EC4899]/15 text-[***REMOVED***EC4899]",
};
...
export function BlogPostPage({ post }: Props) {
  const gradient = CAT_COLOR[post.category] || "bg-[***REMOVED***EC4899]/15 text-[***REMOVED***EC4899]";
...
{/* Per-page 3D Story Scene — blog variant. Sits behind hero content. */}
        <NxStoryScene variant="blog" />
          ...
          <Nx3DCharacter variant="blog-post" size="md" />
        </div>
          ...
          >
            ...
            <div className="mt-5 flex flex-wrap items-center gap-4 text-xs text-muted-foreground">
              <span className="inline-flex items-center gap-1.5">
                <span className="grid h-7 w-7 place-items-center rounded-full bg-[***REMOVED***EC4899] text-white text-[10px] font-bold">
                  CT
                </span>
                {post.author}
              </span>
              ...
              <div className="grid gap-4 sm:grid-cols-3">
                {related.map((r) => (
                  <Link
                    key={r.slug}
                    href={`/blog/${r.slug}`}
                    className="group rounded-xl border border-border bg-[***REMOVED***14141A] p-4 hover:border-primary/40 hover:bg-card/60 transition"
                  >
                    <div className="text-[10px] uppercase tracking-widest text-[***REMOVED***EC4899]">
                      {r.category}
                    </div>
