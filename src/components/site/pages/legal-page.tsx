...
{/* Per-page 3D Story Scene — default variant. Sits behind hero content. */}
        <NxStoryScene variant="default" />
          ...
          >
            {sections.map((s) => (
              <motion.div
                ...
                className="p-6 rounded-2xl border border-border bg-[***REMOVED***14141A] shadow-sm transition-colors hover:bg-card/60 hover:border-border/80"
              >
