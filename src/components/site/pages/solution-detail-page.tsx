...
{/* Per-page 3D Story Scene — solutions variant. Sits behind hero content. */}
        <NxStoryScene variant="solutions" />
          ...
          <Nx3DCharacter variant="solution-detail" size="md" />
        </div>
        ...
        <Nx3DScene density="low" />
          ...
          >
            <div className="flex items-center gap-3 mb-3">
              <div className="grid h-12 w-12 place-items-center rounded-xl bg-[***REMOVED***EC4899]/15 text-[***REMOVED***EC4899] border border-[***REMOVED***EC4899]/30">
            ...
            <h1 className="text-3xl sm:text-4xl lg:text-5xl font-bold tracking-tight text-[***REMOVED***F5F5F0]">
              {solution.title}
            </h1>
            ...
            <div className="grid gap-3 sm:grid-cols-2">
              {solution.our_solution.map((s, i) => (
                <div
                  ...
                  className="flex items-start gap-3 rounded-xl border border-border bg-[***REMOVED***14141A] p-4"
                >
                  <CheckCircle2 className="h-5 w-5 shrink-0 text-[***REMOVED***EC4899] mt-0.5" />
              ...
              <div className="grid gap-3 sm:grid-cols-2">
                {relatedServices.map((s) => (
                  <Link
                    ...
                    className="group flex items-start gap-3 rounded-xl border border-border bg-[***REMOVED***14141A] p-4 hover:border-primary/40 hover:bg-card/60 transition"
                  >
                    <div className="grid h-10 w-10 shrink-0 place-items-center rounded-lg bg-[***REMOVED***EC4899]/15 text-[***REMOVED***EC4899] border border-[***REMOVED***EC4899]/30">
