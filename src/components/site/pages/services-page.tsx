...
export function ServicesPage() {
  return (
    <NxPageLayout>
      ...
      {/* Service Cards */}
      <section className="py-20 px-4 lg:px-8" style={{ background: "***REMOVED***050510" }}>
                      ...
                      <ul className="space-y-2">
                        {card.deliverables.map((d) => (
                          <li key={d} className="flex items-start gap-2 text-[13px] text-white/70">
                            <Check className="h-4 w-4 text-[***REMOVED***EC4899] shrink-0 mt-0.5" />
                            {d}
                          </li>
                        ))}
                      </ul>
      ...
      {/* Process Section */}
      <section className="py-24 px-4 lg:px-8" style={{ background: "***REMOVED***030014" }}>
          ...
          <div className="grid sm:grid-cols-2 lg:grid-cols-4 gap-4">
            {PROCESS_STEPS.map((step, i) => (
              ...
              >
                ...
                <div className="text-[10px] font-mono uppercase tracking-[1.5px] text-[***REMOVED***EC4899] mb-3">
                  {step.weeks}
                </div>
      ...
      <section className="py-20 px-4 lg:px-8" style={{ background: "***REMOVED***030014" }}>
        <div className="mx-auto max-w-5xl">
          <div
    ...
    return (
      <div className="relative" style={{ width: "100px", height: "120px" }}>
        ...
        >
          ...
          >
            <div className="absolute left-1 top-1 w-3 h-3 rounded-full" style={{ background: "***REMOVED***60A5FA" }} />
            <div className="absolute right-1 top-1 w-3 h-3 rounded-full" style={{ background: "***REMOVED***F472B6" }} />
          </div>
        </div>
      </div>
    );
