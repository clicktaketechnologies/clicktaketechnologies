        ...
        <NxPageSection variant="surface" width="wide" padding="tight">
          ...
          >
            <Link
              ...
              className="group relative flex flex-col sm:flex-row items-start sm:items-center justify-between gap-4 sm:gap-6 rounded-3xl border border-[***REMOVED***FF53A9]/30 nx-surface-alt p-5 sm:p-8 transition-all duration-300 hover:border-[***REMOVED***FF53A9]/60 overflow-hidden"
            >
              <div className="pointer-events-none absolute -right-16 -top-16 h-64 w-64 rounded-full bg-[***REMOVED***FF53A9]/8 blur-3xl" />

              <div className="relative flex items-start sm:items-center gap-4 sm:gap-5 min-w-0">
                <div className="h-12 w-12 sm:h-14 sm:w-14 shrink-0 grid place-items-center rounded-2xl nx-orange-gradient shadow-lg shadow-[***REMOVED***FF53A9]/25">
                  <Sparkles className="h-6 w-6 sm:h-7 sm:w-7 text-white" />
                </div>
                <div className="min-w-0">
                  <div className="flex items-center gap-2 mb-1 flex-wrap">
                    <span className="text-[10px] sm:text-xs font-bold uppercase tracking-widest text-[***REMOVED***FF53A9]">Flagship Offering</span>
                    <span className="rounded-full bg-[***REMOVED***FF53A9]/20 border border-[***REMOVED***FF53A9]/30 px-2 py-0.5 text-[10px] font-semibold text-[***REMOVED***FF53A9] uppercase tracking-wider">Most Popular</span>
                  </div>
              ...
              <div className="relative flex items-center gap-3 shrink-0 self-end sm:self-auto">
                <div className="hidden sm:flex flex-col gap-1 text-right">
                  ...
                  <div className="text-sm font-bold text-[***REMOVED***FF53A9]">90 days</div>
                </div>
                <div className="h-10 w-10 rounded-full border border-[***REMOVED***FF53A9]/40 bg-[***REMOVED***FF53A9]/10 grid place-items-center transition-all group-hover:bg-[***REMOVED***FF53A9]/20 group-hover:scale-110">
                  <ArrowUpRight className="h-5 w-5 text-[***REMOVED***FF53A9]" />
                </div>
              </div>
            </Link>
          </motion.div>
              ...
              <div className={`grid sm:grid-cols-2 ${g.items.length === 4 ? "lg:grid-cols-4" : g.items.length === 3 ? "lg:grid-cols-3" : "lg:grid-cols-2 max-w-2xl"} gap-3 sm:gap-4`}>
                {g.items.map((item, ii) => {
                  ...
                  return (
                    ...
                    >
                      <TiltCard
                        className={`group/tilt flex flex-col h-full rounded-2xl border nx-bd nx-surface p-6 transition-colors duration-300 hover:border-[***REMOVED***FF53A9]/40`}
                        glow={true}
                        shine={true}
                      >
        ...
        <div className="relative overflow-hidden rounded-3xl nx-orange-gradient p-8 sm:p-12 md:p-16 text-center">
          ...
          <div className="relative">
            ...
            <div className="flex flex-wrap gap-3 justify-center">
              <Link
                href="/contact"
                className="inline-flex items-center gap-2 rounded-full bg-white px-6 sm:px-8 py-3 sm:py-4 font-bold text-[***REMOVED***E0197A] shadow-lg hover:scale-105 transition-transform text-sm sm:text-base"
              >
