    ...
    <NxPageLayout>
      <div className="max-w-3xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        >
          ...
          <h1 className="mt-3 sm:mt-4 text-3xl sm:text-4xl lg:text-5xl font-bold tracking-tight text-[***REMOVED***F5F5F0] leading-tight">
            {resource.title}
          </h1>
        ...
        {learnPoints.length > 0 && (
          ...
          >
            <div className="flex items-center gap-2 mb-4">
              <FileText className="h-5 w-5 text-[***REMOVED***EC4899] shrink-0" />
        ...
        >
          <div className="flex items-start gap-3">
            <Sparkles className="h-6 w-6 text-[***REMOVED***EC4899] shrink-0 mt-0.5" />
            <div>
              ...
              <div className="mt-5 flex flex-wrap gap-3">
                <Link
                  href="/contact"
                  className="inline-flex items-center gap-2 rounded-[8px] bg-[***REMOVED***EC4899] px-5 py-2.5 text-sm font-semibold text-white shadow-[0_1px_3px_rgba(0,0,0,0.4)] hover:-translate-y-0.5 transition"
                >
                  Book a free consult <Send className="h-4 w-4" />
                </Link>
                <Link
                  href="/blog"
                  className="inline-flex items-center gap-2 rounded-[8px] border border-border bg-[***REMOVED***14141A] px-5 py-2.5 text-sm font-semibold hover:border-[***REMOVED***EC4899]/40 hover:bg-[***REMOVED***1a1a22] transition"
                >
            ...
            <div className="grid gap-4 sm:grid-cols-2">
              {related.map((r) => (
                <Link
                  key={r.slug}
                  href={`/resources/${r.slug}`}
                  className="group rounded-2xl border border-border bg-[***REMOVED***14141A] p-5 hover:border-primary/40 hover:bg-card/60 transition"
                >
