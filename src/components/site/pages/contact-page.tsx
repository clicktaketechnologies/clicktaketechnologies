          ...
          <div key={s} className="flex items-center gap-3">
            <div
              className={`grid h-8 w-8 place-items-center rounded-full text-sm font-bold transition-all ${
                s <= step
                  ? "bg-gradient-to-br from-[***REMOVED***3B82F6] to-[***REMOVED***EC4899] text-white"
            ...
            {s < 3 && (
              <div className={`h-px w-12 ${s < step ? "bg-[***REMOVED***EC4899]" : "bg-white/20"}`} />
            )}
          </div>
        ))}
      </div>
        ...
        >
          <div>
            ...
            <input
              ...
              className="w-full rounded-xl border border-white/10 bg-white/5 px-4 py-3 text-sm text-white placeholder:text-white/30 focus:border-[***REMOVED***EC4899]/50 focus:outline-none focus:ring-2 focus:ring-[***REMOVED***EC4899]/20 transition-all"
            />
          </div>
          <div>
            <label className="block text-[11px] font-mono uppercase tracking-[1.5px] text-white/50 mb-2">
                ...
                <button
                  ...
                  className={`flex items-center gap-2 rounded-xl border px-4 py-3 text-sm text-left transition-all ${
                    formData.needs.includes(opt)
                      ? "border-[***REMOVED***EC4899]/50 bg-[***REMOVED***EC4899]/10 text-white"
                ...
                >
                  <div
                    className={`grid h-4 w-4 place-items-center rounded border ${
                      formData.needs.includes(opt)
                        ? "border-[***REMOVED***EC4899] bg-[***REMOVED***EC4899]"
                        : "border-white/30"
                    }`}
                  >
      ...
      {step === 2 && (
        ...
        >
          <div>
            ...
            <select className="w-full rounded-xl border border-white/10 bg-white/5 px-4 py-3 text-sm text-white focus:border-[***REMOVED***EC4899]/50 focus:outline-none">
          ...
          <div>
            ...
            <textarea
              ...
              className="w-full rounded-xl border border-white/10 bg-white/5 px-4 py-3 text-sm text-white placeholder:text-white/30 focus:border-[***REMOVED***EC4899]/50 focus:outline-none focus:ring-2 focus:ring-[***REMOVED***EC4899]/20 transition-all resize-none"
            />
          </div>
      ...
      {step === 3 && (
        ...
        >
          <div>
            ...
            <input
              type="date"
              className="w-full rounded-xl border border-white/10 bg-white/5 px-4 py-3 text-sm text-white focus:border-[***REMOVED***EC4899]/50 focus:outline-none"
            />
          </div>
          <div>
            <label className="block text-[11px] font-mono uppercase tracking-[1.5px] text-white/50 mb-2">
          ...
          <div className="rounded-xl border border-[***REMOVED***EC4899]/20 bg-[***REMOVED***EC4899]/5 p-4">
          ...
          const content = (
            <div className="flex items-center gap-3 group">
              ...
              <div className="min-w-0 flex-1">
                ...
                <div className="text-sm text-white group-hover:text-[***REMOVED***EC4899] transition-colors truncate">
                  {c.value}
                </div>
              </div>
              {c.href && (
                <ArrowRight className="h-4 w-4 text-white/30 group-hover:text-[***REMOVED***EC4899] transition-colors" />
              )}
            </div>
          );
          return c.href ? (
      ...
      <div className="space-y-4">
        {steps.map((s, i) => (
          <div key={i} className="flex items-start gap-4">
            <div className="grid h-8 w-8 place-items-center rounded-full bg-gradient-to-br from-[***REMOVED***3B82F6] to-[***REMOVED***EC4899] text-sm font-bold text-white shrink-0">
              {s.n}
            </div>
            <div>
