  ...
  return (
    <NxPageLayout>
        ...
        <section className="relative overflow-hidden py-12 lg:py-16">
          ...
          <div className="relative mx-auto max-w-7xl px-4 text-center">
            <motion.div initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }} transition={{ duration: 0.6 }}>
              <div className="inline-flex items-center gap-2 rounded-[8px] border border-[***REMOVED***EC4899]/30 bg-transparent px-4 py-1.5 text-xs mb-6">
                <span className="h-1.5 w-1.5 animate-pulse rounded-full bg-cyan-400" />
                Get in Touch
              </div>
              <h1 className="font-display text-5xl font-bold tracking-tight sm:text-6xl lg:text-7xl">
                Let&apos;s start the <span className="text-[***REMOVED***EC4899]">conversation.</span>
              </h1>
          ...
          <div className="grid gap-4 md:grid-cols-3">
            {OFFICES.map((o, i) => (
              <motion.div
                ...
                className="group rounded-2xl border border-border/40 bg-[***REMOVED***14141A] p-5 transition-all hover:border-[***REMOVED***EC4899]/30"
              >
                <div className="flex items-start gap-3">
                  <div className={`grid h-10 w-10 shrink-0 place-items-center rounded-xl bg-[***REMOVED***EC4899]/15 text-[***REMOVED***EC4899]`}>
        ...
        <section className="mx-auto max-w-7xl px-4 mt-16">
          <div className="grid gap-8 lg:grid-cols-2">
            ...
            <motion.div
              ...
              className="relative overflow-hidden rounded-3xl border border-border/60 bg-[***REMOVED***14141A] p-6 lg:p-8"
            >
              {/* v6: ambient orb removed */}
              <div className="relative">
                <div className="flex items-center gap-2 mb-6">
                  <div className="grid h-10 w-10 place-items-center rounded-xl bg-[***REMOVED***EC4899] text-white">
                  ...
                  {inquirySuccess ? (
                    ...
                    >
                      ...
                      <button
                        ...
                        className="inline-flex w-full items-center justify-center gap-2 rounded-xl bg-[***REMOVED***EC4899] px-6 py-3 font-semibold text-white disabled:opacity-50 disabled:cursor-not-allowed hover:-translate-y-0.5 transition"
                      >
          ...
          <div className="grid gap-6 md:grid-cols-3">
            {CONTACT_METHODS.map((m, i) => {
              ...
              return (
                ...
                >
                  <TiltCard
                    className="group/tilt flex items-center gap-4 overflow-hidden rounded-2xl border border-border/60 bg-[***REMOVED***14141A] p-4 transition-colors duration-300 hover:border-[***REMOVED***EC4899]/40"
                    glow={true}
                    shine={true}
                    maxTilt={8}
                  >
                    <a href={m.href} target="_blank" rel="noreferrer" className="contents">
                      <div className={`grid h-14 w-14 shrink-0 place-items-center rounded-2xl bg-[***REMOVED***EC4899]/15 text-[***REMOVED***EC4899]`}>
      ...
      <div className="fixed bottom-6 right-6 z-50 flex flex-col items-end gap-3">
        <AnimatePresence>
          {chatOpen && (
            <motion.div
              ...
              className="w-[20rem] max-w-[calc(100vw-3rem)] rounded-2xl border border-border bg-[***REMOVED***14141A] shadow-2xl overflow-hidden"
            >
              <div className="bg-[***REMOVED***EC4899] p-4 text-white">
        ...
        >
          {/* Inner gradient core */}
          <span className="absolute inset-0 rounded-full bg-[***REMOVED***EC4899]" />
          {/* Glossy highlight */}
          <span className="absolute inset-0 rounded-full bg-white/10" />
          {/* Idle pulse ring (hidden when open) */}
          {!chatOpen && (
            <span className="absolute inset-0 rounded-full bg-[***REMOVED***EC4899]/60 animate-ping opacity-40" aria-hidden />
          )}
          {/* Icon */}
