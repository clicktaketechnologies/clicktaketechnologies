      ...
      <div className="relative mx-auto max-w-7xl px-4 lg:px-8 py-16 sm:py-20">
              ...
              {SITE.socials.slice(0, 4).map((s) => {
                ...
                return (
                  <a
                    ...
                    aria-label={s.name}
                    className="h-10 w-10 rounded-lg bg-white/5 border border-white/10 grid place-items-center text-white/70 hover:bg-[***REMOVED***FF53A9] hover:text-white hover:border-[***REMOVED***FF53A9] transition"
                  >
        ...
        <div className="mt-14 pt-8 border-t border-[***REMOVED***FF53A9]/15 flex flex-col sm:flex-row items-center justify-between gap-4">
          ...
          <div className="flex items-center gap-5 text-xs text-white/50">
            <Link href="/legal" className="hover:text-[***REMOVED***FF8AC4] transition">Privacy</Link>
            <Link href="/legal" className="hover:text-[***REMOVED***FF8AC4] transition">Terms</Link>
            <Link href="/legal" className="hover:text-[***REMOVED***FF8AC4] transition">Cookies</Link>
          </div>
        </div>
      </div>
    </footer>
