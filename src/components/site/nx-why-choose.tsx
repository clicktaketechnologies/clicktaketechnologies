                ...
                <button
                  ...
                  className={`w-full text-left p-5 rounded-xl border transition-all group ${
                    isActive
                      ...
                      : "border-[***REMOVED***E2E8F0] bg-white hover:border-[***REMOVED***CBD5E1]"
                  }`}
                  style={isActive
                ...
                >
                  <div className="flex items-center justify-between gap-4">
                    <div className="flex items-center gap-3">
                      ...
                      <div>
                        <div className={`font-bold text-base ${isActive ? "text-[***REMOVED***0A1124]" : "text-[***REMOVED***0A1124]"}`}>
                          {p.title}
                        </div>
            ...
            <AnimatePresence mode="wait">
              ...
              >
                ...
                <div className="flex items-center gap-2 mb-4">
                  ...
                  />
                  <span className="nx-eyebrow text-[***REMOVED***94A3B8]">
                    {current.title}
                  </span>
                </div>

                {/* Headline */}
                <h3 className="text-2xl sm:text-3xl font-black tracking-tight text-[***REMOVED***0A1124] leading-tight">
                  {current.headline}
                </h3>

                {/* Body */}
                <p className="mt-5 text-base text-[***REMOVED***475569] leading-relaxed">
                  {current.body}
                </p>
                ...
                <ul className="mt-8 grid sm:grid-cols-2 gap-3">
                  {current.points.map((point, i) => (
                    <motion.li
                      ...
                      className="flex items-start gap-2.5 text-sm text-[***REMOVED***0A1124]"
                    >
                      <span
                ...
                {/* CTA */}
                <div className="mt-8 pt-6 border-t border-[***REMOVED***E2E8F0]">
                  <Link
                    href="/contact"
