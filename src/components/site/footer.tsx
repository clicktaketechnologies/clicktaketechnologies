          ...
          <div className="lg:col-span-4">
            <Link href="/" className="flex items-center gap-3 group">
              <div className="relative h-12 w-12 overflow-hidden rounded-2xl border ct-divider shadow-lg transition-all duration-500 group-hover:rotate-6 group-hover:scale-105">
                ...
                />
                <div className="absolute inset-0 bg-gradient-to-tr from-[***REMOVED***136DFF]/20 to-transparent opacity-0 transition-opacity duration-500 group-hover:opacity-100" />
              </div>
            ...
            <div className="mt-6 space-y-2">
              ...
              >
                <Mail className="h-4 w-4 text-[***REMOVED***136DFF]" />
                {SITE.email}
              </a>
              <div className="flex flex-wrap gap-x-6 gap-y-2">
                {SITE.phones.map((p) => (
                  <a
                    ...
                    className="flex items-center gap-2 text-sm text-muted-foreground hover:text-foreground transition"
                  >
                    <Phone className="h-4 w-4 text-[***REMOVED***FF53A9]" />
                    <span>{p.value}</span>
              ...
              <a
                ...
                className="flex items-center gap-2 text-sm text-muted-foreground hover:text-foreground transition"
              >
                <Globe className="h-4 w-4 text-[***REMOVED***136DFF]" />
                {SITE.domain}
              </a>
            </div>
