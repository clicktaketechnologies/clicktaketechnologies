...
export function GET() {
  const md = `***REMOVED*** auth.md — ClickTake Technologies
...
***REMOVED******REMOVED*** 4. Token lifecycle
...
***REMOVED******REMOVED*** 5. MCP and Agent Skills
...
***REMOVED******REMOVED*** 7. Acceptable use
