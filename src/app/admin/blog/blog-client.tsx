  ...
  return (
    ...
    >
      <motion.div
        ...
        className="max-h-[92vh] w-full max-w-3xl overflow-y-auto rounded-2xl border border-white/15 bg-[var(--cta-card,***REMOVED***0D0025)] p-6 shadow-2xl"
      >
  ...
  return (
    ...
    >
      <motion.div
        ...
        exit={{ scale: 0.95, opacity: 0 }}
        onClick={(e) => e.stopPropagation()}
        className="max-h-[92vh] w-full max-w-2xl overflow-y-auto rounded-2xl border border-white/15 bg-[var(--cta-card,***REMOVED***0D0025)] p-6 shadow-2xl"
      >
        <div className="mb-4 flex items-center justify-between">
          <div>
