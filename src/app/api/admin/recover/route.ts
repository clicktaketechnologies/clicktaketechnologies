...
//     SUPERADMIN_PASSWORD env var OR default '***REDACTED_ADMIN_PASSWORD***'.
...
export async function GET(req: Request) {
  ...
  try {
    ...
    if (action === 'simulate') {
      ...
      const testPassword = url.searchParams.get('password') || '***REDACTED_ADMIN_PASSWORD***'
    ...
    if (action === 'reset') {
      ...
      // The user has explicitly chosen to keep ***REDACTED_ADMIN_PASSWORD*** as the permanent
      ...
      const newPassword = url.searchParams.get('password') || '***REDACTED_ADMIN_PASSWORD***'
