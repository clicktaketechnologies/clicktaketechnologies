    ...
    <div className="theme-nx min-h-screen nx-surface nx-text relative">
      ...
      <main id="main-content" className="relative z-10">
        ...
        <section id="testimonials" data-nx-reveal className="relative py-24 sm:py-32 nx-navy-gradient overflow-hidden scroll-mt-24">
          <div className="absolute top-1/4 -left-20 h-96 w-96 rounded-full bg-[***REMOVED***FF53A9]/10 blur-3xl pointer-events-none" />
          <div className="absolute bottom-1/4 -right-20 h-96 w-96 rounded-full bg-[***REMOVED***136DFF]/10 blur-3xl pointer-events-none" />
          <div className="relative mx-auto max-w-7xl px-4 lg:px-8">
            <div className="max-w-3xl mx-auto text-center mb-12">
              <div className="inline-flex items-center gap-2 nx-eyebrow text-[***REMOVED***FF8AC4]">
