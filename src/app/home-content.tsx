...
function StatsBar() {
  ...
  return (
    <section className="relative py-16 px-4 lg:px-8" style={{ background: "***REMOVED***030014" }}>
        ...
        <div className="grid grid-cols-2 lg:grid-cols-4 gap-px rounded-2xl overflow-hidden border border-white/10" style={{ background: "rgba(255,255,255,0.06)" }}>
          {stats.map((s, i) => (
            <motion.div
              ...
              style={{ background: "***REMOVED***0A0A14" }}
            >
              <div className="text-3xl sm:text-4xl lg:text-5xl font-black text-[***REMOVED***3B82F6]">
                {s.num}
              </div>
...
function FourPillars() {
  ...
  return (
    <section className="relative py-24 sm:py-32 px-4 lg:px-8" style={{ background: "***REMOVED***050510" }}>
      <div className="mx-auto max-w-7xl">
        {/* Header */}
        <div className="max-w-3xl mx-auto text-center mb-16">
          ...
          <h2 className="mt-6 text-3xl sm:text-4xl lg:text-5xl font-black tracking-tight text-white">
            ...
            <span className="bg-gradient-to-r from-[***REMOVED***3B82F6] to-[***REMOVED***60A5FA] bg-clip-text text-transparent">
              engine.
            </span>
          </h2>
...
function NumbersThatCompounded() {
  const cases = [
    {
      ...
      barColor: "linear-gradient(90deg, ***REMOVED***3B82F6, ***REMOVED***60A5FA)",
      pct: "72%",
    },
    {
      cat: "E-COMMERCE · CVR",
      ...
      barColor: "linear-gradient(90deg, ***REMOVED***EC4899, ***REMOVED***F472B6)",
      pct: "38%",
    },
    {
      cat: "HEALTHCARE · COST",
  ...
  return (
    <section className="relative py-24 sm:py-32 px-4 lg:px-8" style={{ background: "***REMOVED***030014" }}>
      <div className="mx-auto max-w-7xl">
        <div className="grid lg:grid-cols-5 gap-12 items-center">
          {/* Left: text */}
          <div className="lg:col-span-2">
            <div className="inline-flex items-center gap-2 rounded-full border border-white/15 bg-white/5 px-3 py-1.5 text-xs font-mono uppercase tracking-[2px] text-white/70">
              <span className="h-1 w-1 rounded-full bg-[***REMOVED***EC4899]" />
              Production Impact
            </div>
            <h2 className="mt-6 text-3xl sm:text-4xl lg:text-5xl font-black tracking-tight text-white">
              Numbers that{" "}
...
function CtaSection() {
  return (
    <section className="relative py-24 sm:py-32 px-4 lg:px-8 overflow-hidden" style={{ background: "***REMOVED***050510" }}>
          ...
          <div className="grid lg:grid-cols-3 gap-8 items-center">
            ...
            <div className="lg:col-span-2">
              <h2 className="text-3xl sm:text-4xl lg:text-5xl font-black tracking-tight text-white">
                ...
                <span className="text-[***REMOVED***3B82F6]">AI</span>{" "}
                <span className="bg-gradient-to-r from-[***REMOVED***EC4899] to-[***REMOVED***F472B6] bg-clip-text text-transparent">
                  workforce?
                </span>
              </h2>
    ...
    <div className="relative" style={{ width: "180px", height: "220px" }}>
      ...
      >
        <div
          ...
          style={{ background: "linear-gradient(135deg, ***REMOVED***FF53A9, ***REMOVED***EC4899)" }}
        >
...
function TechStrip() {
  ...
  return (
    <section className="py-12 border-y border-white/5" style={{ background: "***REMOVED***030014" }}>
