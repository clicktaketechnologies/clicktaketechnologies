    ...
    subsections: [
      {
        ...
        jargon: [
          { term: "DNS (Domain Name System)", def: "The internet's phone book — maps your domain (yourbrand.com) to the server IP where your website lives, and to Google's mail servers for email. Misconfigured DNS is the ***REMOVED***1 cause of 'my email goes to spam' and 'my website is down'." },
