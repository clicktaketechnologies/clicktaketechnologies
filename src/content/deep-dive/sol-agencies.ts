    ...
    subsections: [
      ...
      },
      {
        ...
        jargon: [
          ...
          { term: "Scope creep", def: "The expansion of a project's scope beyond the original Statement of Work (SoW) without corresponding budget increase. Scope creep is the ***REMOVED***1 margin-killer on agency engineering work. We ship fixed-scope SoWs with explicit out-of-scope lists + change-order process: any scope addition requires a written change order signed by the agency before work starts. Change orders are billable at the same wholesale rate." },
