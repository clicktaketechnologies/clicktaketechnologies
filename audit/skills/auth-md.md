***REMOVED*** Skill: Implement Auth.md Agent Registration Discovery

***REMOVED******REMOVED*** What This Skill Does
...
- Serve `/auth.md` from the service root as Markdown with an H1 heading that contains `auth.md` (for example, `***REMOVED*** auth.md` or `***REMOVED*** Example auth.md`).
