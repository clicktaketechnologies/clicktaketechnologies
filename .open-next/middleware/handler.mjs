...
var init_cloudflare_edge = __esm({
  "node_modules/@opennextjs/aws/dist/overrides/wrappers/cloudflare-edge.js"() {
    cfPropNameMapping = {
      ...
      // See https://github.com/vercel/vercel/blob/4cb6143/packages/functions/src/headers.ts***REMOVED***L94C19-L94C37
...
var require_node_modules_next_dist_esm_build_templates_edge_wrapper_78fa9d6a = __commonJS({
  ".next/server/edge/chunks/node_modules_next_dist_esm_build_templates_edge-wrapper_78fa9d6a.js"() {
    "use strict";
    (globalThis.TURBOPACK || (globalThis.TURBOPACK = [])).push(["chunks/node_modules_next_dist_esm_build_templates_edge-wrapper_78fa9d6a.js", 435825, (e, t, l) => {
      self._ENTRIES ||= {};
...
var require_root_of_the_server_25fe7590 = __commonJS({
  ".next/server/edge/chunks/[root-of-the-server]__25fe7590._.js"() {
    "use strict";
    (globalThis.TURBOPACK || (globalThis.TURBOPACK = [])).push(["chunks/[root-of-the-server]__25fe7590._.js", 828042, (e, t, r) => {
      "use strict";
      ...
      function i(e2) {
        ...
        return "Minified React error ***REMOVED***" + e2 + "; visit " + t2 + " for the full message or use the non-minified dev environment for full errors and additional helpful warnings.";
      }
      var a = Array.isArray;
      function o() {
      }
...
Learn More: https://nextjs.org/docs/messages/node-module-in-edge-runtime`;
  ...
  `);
      ...
      function O(e10) {
        let t2 = e10.indexOf("***REMOVED***"), r2 = e10.indexOf("?"), n2 = r2 > -1 && (t2 < 0 || r2 < t2);
      ...
      var A, j, L, D, q, U, $, B, V, H, G, W, z = e.i(828042);
      ...
      class ed extends Error {
        constructor() {
          super("Cookies can only be modified in a Server Action or Route Handler. Read more: https://nextjs.org/docs/app/api-reference/functions/cookies***REMOVED***options");
        }
        static callable() {
          throw new ed();
        }
      ...
      let eI = process.env.NEXT_OTEL_PERFORMANCE_PREFIX, { context: ek, propagation: eM, trace: eA, SpanStatusCode: ej, SpanKind: eL, ROOT_CONTEXT: eD } = t = e.r(459110);
      ...
      async function ts(t2) {
        ...
        if (o2 && R2 && !p2) {
          ...
          o2 = new Response(o2.body, o2), e10.host === h2.host && (e10.buildId = f2 || e10.buildId, o2.headers.set("Location", ee(e10, h2).url)), v2 && (o2.headers.delete("Location"), o2.headers.set("x-nextjs-redirect", ee(e10.toString(), h2.toString()).url));
        }
      ...
      function tu(e10) {
        ...
        if ("/admin/login" === t2 || "/admin/create-admin" === t2 || "/admin/forgot-password" === t2) return Z.next();
        if (!(e10.cookies.get("next-auth.session-token")?.value || e10.cookies.get("__Secure-next-auth.session-token")?.value)) {
          let r2 = new URL("/admin/login", e10.url);
          return r2.searchParams.set("callbackUrl", t2), Z.redirect(r2);
        }
        return Z.next();
      }
      RegExp(`\\n\\s+at Suspense \\(<anonymous>\\)(?:(?!\\n\\s+at (?:body|div|main|section|article|aside|header|footer|nav|form|p|span|h1|h2|h3|h4|h5|h6) \\(<anonymous>\\))[\\s\\S])*?\\n\\s+at __next_root_layout_boundary__ \\([^\\n]*\\)`), RegExp(`\\n\\s+at __next_metadata_boundary__[\\n\\s]`), RegExp(`\\n\\s+at __next_viewport_boundary__[\\n\\s]`), RegExp(`\\n\\s+at __next_outlet_boundary__[\\n\\s]`), e.s([], 985835), e.i(985835), e.s(["config", 0, { matcher: ["/admin/:path*", "/api/admin/:path*"] }, "middleware", () => tu], 196592);
      var tc = e.i(196592);
...
var require_turbopack_node_modules_next_dist_esm_build_templates_edge_wrapper_99e3e1b8 = __commonJS({
  ".next/server/edge/chunks/turbopack-node_modules_next_dist_esm_build_templates_edge-wrapper_99e3e1b8.js"() {
    "use strict";
    (globalThis.TURBOPACK || (globalThis.TURBOPACK = [])).push(["chunks/turbopack-node_modules_next_dist_esm_build_templates_edge-wrapper_99e3e1b8.js", { otherChunks: ["chunks/node_modules_next_dist_esm_build_templates_edge-wrapper_78fa9d6a.js", "chunks/[root-of-the-server]__25fe7590._.js"], runtimeModuleIds: [435825] }]), (() => {
      let e;
      ...
      let C = function(e2) {
        ...
        for (let t3 in r2.href = e2, r2.pathname = e2.replace(/[?***REMOVED***].*/, ""), r2.origin = r2.protocol = "", r2.toString = r2.toJSON = (...t4) => e2, r2) Object.defineProperty(this, t3, { enumerable: true, configurable: true, value: r2[t3] });
      };
      function j(e2, t2) {
...
importScripts(...self.TURBOPACK_NEXT_CHUNK_URLS.map(c => self.TURBOPACK_WORKER_LOCATION + c).reverse());`], { type: "text/javascript" });
      ...
      function L(t2) {
        let r2, n2 = function(e2) {
          ...
          let t3 = decodeURIComponent(("u" > typeof TURBOPACK_NEXT_CHUNK_URLS ? TURBOPACK_NEXT_CHUNK_URLS.pop() : e2.getAttribute("src")).replace(/[?***REMOVED***].*$/, ""));
...
var init_edgeFunctionHandler = __esm({
  "node_modules/@opennextjs/aws/dist/core/edgeFunctionHandler.js"() {
    ...
    globalThis._ROUTES = [{ "name": "middleware", "page": "/", "regex": ["^(?:\\/(_next\\/data\\/[^/]{1,}))?\\/admin(?:\\/((?:[^\\/***REMOVED***\\?]+?)(?:\\/(?:[^\\/***REMOVED***\\?]+?))*))?(\\\\.json)?[\\/***REMOVED***\\?]?$", "^(?:\\/(_next\\/data\\/[^/]{1,}))?\\/api\\/admin(?:\\/((?:[^\\/***REMOVED***\\?]+?)(?:\\/(?:[^\\/***REMOVED***\\?]+?))*))?(\\\\.json)?[\\/***REMOVED***\\?]?$"] }];
...
var BuildId = "-GcUC8lJ8xqg7Tr2y17yB";
...
function escapePathDelimiters(segment, escapeEncoded) {
  return segment.replace(new RegExp(`([/***REMOVED***?]${escapeEncoded ? "|%(2f|23|3f|5c)" : ""})`, "gi"), (char) => encodeURIComponent(char));
}
...
function parse2(str, options) {
  ...
  var _a = options.prefixes, prefixes = _a === void 0 ? "./" : _a, _b = options.delimiter, delimiter = _b === void 0 ? "/***REMOVED***?" : _b;
  var result = [];
  var key = 0;
  var i = 0;
  var path3 = "";
...
function tokensToRegexp(tokens, keys, options) {
  ...
  var _a = options.strict, strict = _a === void 0 ? false : _a, _b = options.start, start = _b === void 0 ? true : _b, _c = options.end, end = _c === void 0 ? true : _c, _d = options.encode, encode = _d === void 0 ? function(x) {
    return x;
  } : _d, _e = options.delimiter, delimiter = _e === void 0 ? "/***REMOVED***?" : _e, _f = options.endsWith, endsWith = _f === void 0 ? "" : _f;
