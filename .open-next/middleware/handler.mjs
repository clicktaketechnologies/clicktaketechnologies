...
Learn More: https://nextjs.org/docs/messages/node-module-in-edge-runtime`;
  ...
  `);
      ...
      let tu = "clicktaketech.com";
      function tc(e10) {
        let { pathname: t2, hostname: r2 } = e10.nextUrl;
        if (r2 === `www.${tu}`) {
          let t3 = new URL(e10.url);
          return t3.hostname = tu, Z.redirect(t3, 308);
        }
        if (!t2.startsWith("/admin") || "/admin/login" === t2 || "/admin/create-admin" === t2 || "/admin/forgot-password" === t2) return Z.next();
      ...
      e.s(["config", 0, { matcher: ["/((?!_next/static|_next/image|favicon.ico|api/.*|.*\\.(?:png|jpg|jpeg|gif|webp|svg|ico|css|js|woff|woff2|ttf|eot|otf|map|txt|xml).*$).*)"] }, "middleware", () => tc], 96592);
      var td = e.i(96592);
...
var init_edgeFunctionHandler = __esm({
  "node_modules/@opennextjs/aws/dist/core/edgeFunctionHandler.js"() {
    ...
    globalThis._ROUTES = [{ "name": "middleware", "page": "/", "regex": ["^(?:\\/(_next\\/data\\/[^/]{1,}))?(?:\\/((?!_next\\/static|_next\\/image|favicon.ico|api\\/.*|.*\\.(?:png|jpg|jpeg|gif|webp|svg|ico|css|js|woff|woff2|ttf|eot|otf|map|txt|xml).*$).*))(\\\\.json)?[\\/***REMOVED***\\?]?$"] }];
...
var BuildId = "362xTBd4iwOrF9i9vmxbC";
