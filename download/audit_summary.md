***REMOVED*** Ahrefs Site Audit — Issue Summary & Fix Plan
...
***REMOVED******REMOVED******REMOVED*** ERROR (6 issue types — 4 distinct root causes)
...
***REMOVED******REMOVED******REMOVED*** WARNING (2 issue types)
...
***REMOVED******REMOVED******REMOVED*** NOTICE (2 issue types)
...
***REMOVED******REMOVED******REMOVED*** Tier 1 — Critical (do first, biggest impact)
...
***REMOVED******REMOVED******REMOVED*** Tier 2 — High (large affected-page count)
...
***REMOVED******REMOVED******REMOVED*** Tier 4 — Low / data hygiene
